export default {
  ...
  settings: {
    ...
    attachment: {
      ...
      defaultImageScaleHint:
        '按图片原始尺寸设置默认比例，实际显示不会超过编辑区域宽度',
      responsiveImages: '图片自适应编辑区域',
      responsiveImagesHint:
        '窗口或内容栏变窄时自动等比收缩，恢复宽度后回到设定比例',
    ...
    gitSync: {
      ...
      branch: {
        title: '同步分支',
        desc: '检测到其他分支时可在此切换',
        mainLabel: '{branch}（主分支）',
        targetBranch: '目标',
        selectTitle: '选择同步分支',
        switchAndSync: '切换并同步',
        selectMessageEmpty: '请选择要同步的分支',
  ...
  plugins: {
    ...
    uninstallConfirmMessage: '确定要卸载“{plugin}”吗？',
    uninstallConfirmAction: '继续卸载',
    uninstallDataTitle: '处理插件数据',
    uninstallDataMessage:
      '卸载“{plugin}”前，请选择是否同时删除该插件的相关数据。\n• 删除的数据包括插件设置、状态数据及插件专用数据库内容\n• 删除后无法恢复；保留数据可在重新安装后继续使用',
    uninstallKeepData: '保留数据并卸载',
    uninstallDeleteData: '删除数据并卸载',
    uninstallSuccess: '本地插件已卸载，用户数据已保留',
    uninstallWithDataSuccess: '本地插件及相关数据已删除',
  ...
  shortcut: {
    ...
    local_ai_chatHotkey: 'AI 聊天快捷键：',
    local_ai_chatHotkeyDesc: '设置打开 AI 聊天并新建对话的快捷键',
  ...
  dataManager: {
    title: '数据与存储',
    locationsTitle: '存储位置',
    locationsDesc: '点击路径可在资源管理器中打开；内容与本机状态分开存放',
    workspaceDir: 'Markdown 工作区：',
    workspaceDirDesc: '存放片段、笔记和附件；点击路径可在资源管理器中打开',
    ...
    snippetDir: '应用数据目录：',
    snippetDirDesc:
      '存放本机配置、索引和插件数据；点击路径可在资源管理器中打开',
    changePath: '修改数据目录',
    pluginDir: '插件安装目录：',
    pluginDirDesc: '存放已安装插件包；目录修改仍由插件管理页面负责',
    logDir: '应用日志目录：',
    logDirDesc: '存放诊断日志，不包含 Markdown 工作区内容',
    openDirectory: '在资源管理器中打开',
    ...
    indexAll: '全部本机来源索引',
    indexApps: '应用索引',
    indexBookmarks: '浏览器书签索引',
    indexDesktopFiles: '桌面文件索引',
    indexAppsSuccess: '应用索引已提交重建，应用即将重启',
    indexBookmarksSuccess: '书签索引已提交重建，应用即将重启',
    indexDesktopFilesSuccess: '桌面文件索引已提交重建，应用即将重启',
    indexAllSuccess: '本机来源索引已提交重建，应用即将重启',
    indexFailed: '重建本机来源索引失败',
    markdownIndex: 'Markdown 搜索索引',
    markdownIndexDesc: '根据当前工作区重新构建片段与笔记的内存搜索索引',
    markdownIndexSuccess: 'Markdown 搜索索引已重建',
    markdownIndexFailed: '重建 Markdown 搜索索引失败',
    cleanupTitle: '历史与缓存',
    cleanupDesc: '每项操作只处理标明的数据域，不会级联删除用户内容',
    clearAction: '清理',
    searchHistory: '搜索使用历史',
    searchHistoryDesc: '按来源清除搜索排序记录，不删除索引、图标、应用或文件',
    searchHistorySelect: '请选择要清除的历史范围：',
    historyAll: '全部使用历史',
    historyApps: '应用使用历史',
    historyBookmarks: '书签使用历史',
    historyDesktopFiles: '桌面文件使用历史',
    historyMarkdown: '片段与笔记使用历史',
    searchHistorySuccess: '已清除 {count} 条使用历史',
    searchHistoryFailed: '清除使用历史失败',
    iconCache: '图标缓存',
    ...
    wallpaperCacheConfirm: '清理未使用的壁纸下载缓存，是否继续？',
    wallpaperCacheSuccess: '壁纸缓存已清理',
    wallpaperCacheFailed: '清理壁纸缓存失败',
    sizeUnknown: '正在读取',
    pathWarning:
      '修改应用数据目录会迁移本机配置、索引和插件数据并重启应用，是否继续？',
    pathSuccess: '应用数据目录修改成功，应用将重启以应用更改',
    pathFailed: '修改数据目录失败',
    warning: '警告'
  },
  ...
  retrieve: {
    ...
    urlFormatTip:
      '在 URL 模板中使用 %s 作为占位符，搜索关键词将自动替换到该位置。',
    icon: '搜索引擎图标',
    iconColumn: '图标',
    default: '默认',
    off: '关闭',
  ...
  darkMode: {
    ...
    sunCalcTitle: '计算信息',
    sunCalcSource: '来源',
    sunCalcCoordinates: '计算坐标',
    sunCalcTimezoneOffset: '时区偏移（分钟）',
    sunCalcSunset: '切换日落时间',
    sunCalcError: '错误',
    sunCalcManualLocation: '手动位置（{city}）',
    sunCalcAutoLocation: '自动定位（{city}）'
  },
  ...
  pin: {
    ...
    offlineModelNotDownloaded: '离线模型未下载，请在翻译设置中下载',
    offlineModelNotActivated: '离线模型未启用，请在翻译设置中启用',
    sourceText: '原文',
    selectedText: '已选文字',
    translationResult: '译文',
    viewResult: '查看结果',
    sourceImage: '原始图片',
    selectableTextView: '可选文字',
    selectableTextPreparing: '正在生成可选文字层',
    nativeTextSelectionHint: '直接在图片上拖选文字，Ctrl+A 可全选',
  ...
  wallpaperSwitcher: {
    ...
    mode: '模式',
    fixedImage: '固定图片',
    fixedImageCaption: '保持当前画面',
    localFolder: '本地文件夹',
    localFolderCaption: '轮换个人图库',
    systemSettings: 'Windows 系统设置',
    wallhavenOnline: 'Wallhaven 在线',
    wallhavenCaption: '发现在线壁纸',
    stepOne: '步骤 1 · 来源',
    chooseSource: '选择壁纸来源',
    ready: '已就绪',
    localLibrary: '本地图库',
    ...
    imagePath: '图片文件',
    change: '更换',
    onlineSourceHint: '从在线图库自动获取高清壁纸',
    browseOnline: '浏览在线图库',
    browseOnlineHint: '搜索、预览并直接应用',
    fixedModeHint: '停止轮换并保持这一张壁纸',
    selectImage: '选择图片',
    select: '选择',
    scan: '扫描',
    ...
    switchRules: '切换规则',
    stepTwo: '步骤 2 · 自动化',
    automationTitle: '自动切换',
    automationHint: '按你的节奏持续更新桌面',
    enableSchedule: '启用定时切换',
    scheduleRunning: '自动切换中',
    schedulePaused: '自动切换已暂停',
    interval: '切换间隔',
    every: '每',
    minutes: '分钟',
    rotationOrder: '轮换顺序',
    sequential: '顺序',
    random: '随机',
    folderSortLabel: '排序依据',
    folderSort: {
      createdAscending: '创建时间',
      fileNameAscending: '文件名',
      modifiedDescending: '最近修改'
    },
    type: '类型',
    autoRestore: '启动后自动恢复定时任务',
    autoRestoreShort: '随应用恢复',
    autoRestoreHint: '下次启动继续自动切换',
    trayQuickSwitch: '托盘快捷切换',
    trayQuickSwitchHint: '无需打开窗口，右键托盘即可切换下一张',
    cache: '缓存',
    ...
    setting: '设置中',
    set: '设为',
    preparingDownload: '正在连接图源',
    waitingForSize: '正在获取文件大小',
    downloadReady: '下载完成',
    downloadedSize: '已接收 {size}',
    downloading: '下载中',
    download: '下载',
    page: '第 {page} 页',
  ...
  update: {
    ...
    startDownload: '开始下载',
    downloading: '正在下载',
    downloadComplete: '安装包已下载并缓存。',
    cachedInstallerReady: '安装包已缓存，可选择安装时间。',
    installing: '正在启动安装程序...',
    ...
    installLater: '稍后安装',
    installNow: '立即安装',
    installOnNextRestart: '下次重启自动安装',
    installScheduledOnRestart: '已设置为下次启动时自动安装。',
    readyToDownload: '{version} 可下载。',
  ...
  translate: {
    ...
    offlineMark: '离',
    offlineModelUnavailable: '离线模型未下载，请在设置中下载',
    offlineUnavailable: '离线翻译不可用，请在设置中安装并启用',
    languages: {
      auto: '自动检测',
      zh: '简体中文',
      zh_tw: '繁体中文',
  ...
  screenRecorder: {
    ...
    exportDone: '导出完成',
    trimTitle: '剪辑录制内容',
    trimHint: '拖动黄色手柄选择要保留的片段',
    trimPreview: '剪辑预览',
    trimPreparing: '正在生成剪辑预览...',
    previewUnavailable: '预览暂不可用，仍可按当前范围导出',
    trimDuration: '保留时长',
    previewCurrentTime: '当前预览时间',
    trimStart: '剪辑起点',
    trimEnd: '剪辑终点',
    playPreview: '播放预览',
    pausePreview: '暂停预览',
    ...
    folder: '文件夹',
    again: '重录',
    savedWithAudio: '已保存·有声',
    savedWithoutAudio: '已保存·无声',
    cancelExport: '取消导出',
    minimize: '最小化',
    snapToWindow: '拖到目标窗口并松开以对齐',
    audioStatus: '系统声音录制状态',
    gifAudioUnsupported: 'GIF 不支持音频',
    audioMeterUnavailable: '音频已开启；实时音量动画不可用不影响导出系统声音',
    ...
    viewportNotReady: '录制视口尚未准备好',
    recordingAreaTooSmall: '录制区域太小，请放大录制窗口',
    preparingGif: '准备生成 GIF 帧',
    preparingMp4: '准备导出 MP4',
    debugLog: '调试日志',
    saveRecording: '保存录屏',
  ...
  localAi: {
    ...
    chatEmpty: '输入内容后开始对话',
    chatPlaceholder: '描述你的目标、背景和期望结果…',
    inputHint: 'Enter 发送 · Shift + Enter 换行',
    privateWorkspace: '本地私有工作台',
    chatWelcomeTitle: '今天想一起完成什么？',
    chatWelcomeDesc:
      '从一个具体目标开始，我可以帮你整理信息、解释代码、翻译内容或完善想法。',
    quickStart: '快速开始',
    quickStartHint: '选择一个常用场景，继续补充细节',
    composerLabel: '消息',
    privateLocalHint: '对话内容由本地模型处理',
    dragDropHint: '支持拖入文件或粘贴图片',
    newChat: '新对话',
    newChatTitle: '新对话',
    recent: '最近对话',
    clearAllChats: '清空全部对话',
    clearAllChatsConfirm: '确认删除全部对话和其中的附件数据？此操作无法撤销。',
    clearAllChatsSuccess: '全部对话和附件数据已清空',
    searchHistory: '搜索对话',
    ...
    quickPromptSummaryDesc: '提炼重点、结论与待办',
    quickPromptTranslate: '翻译并保留 Markdown',
    quickPromptTranslateDesc: '保留语气、结构和原始格式',
    quickPromptCode: '解释这段代码',
    quickPromptCodeDesc: '逐步说明逻辑、依赖与风险',
    quickPromptRegex: '生成一段正则表达式',
    quickPromptRegexDesc: '按描述生成规则并给出示例',
    enhancePrompt: '增强提示词',
    ...
    runtimeOverview: '运行状态',
    runtimeOverviewDesc: '查看运行时、模型、服务和资源估算状态',
    serviceControl: '服务控制',
