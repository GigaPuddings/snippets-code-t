export default {
  ...
  setup: {
    ...
    createWorkspaceDesc: '在默认位置创建新的工作区。',
    create: '创建',
    openWorkspace: '打开工作区',
  ...
  settings: {
    ...
    markdownEditorDesc: '统一配置富文本源码预览和代码片段编辑体验',
    markdownShowLineNumbers: '显示行号',
    markdownShowLineNumbersDesc: '在 Markdown 源码视图中显示行号',
    markdownIndentWithTab: 'Tab 缩进',
    markdownIndentWithTabDesc: '在 Markdown 源码和代码编辑器中使用 Tab 插入缩进',
    markdownTabSize: '缩进宽度',
    markdownTabSizeDesc: '设置 Tab 缩进对应的空格数',
    exitApp: '退出应用',
    exitAppDesc: '是否退出应用',
