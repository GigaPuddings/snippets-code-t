export default {
  ...
  wallpaperSwitcher: {
    ...
    folderOrder: '文件夹切换',
    sequential: '顺序切换',
    randomNoRepeat: '随机（整轮不重复）',
    sortBy: '排序',
    sortFileNameAscending: '文件名（升序）',
    sortFileNameDescending: '文件名（降序）',
    sortModifiedAscending: '修改日期（最早）',
    sortModifiedDescending: '修改日期（最新）',
    hot: '热门',
    toplist: '排行榜',
    favorites: '收藏',
    hotWithLabel: '热门 Hot',
    ...
    taskbarTransparentHint: '保存后立即生效；关闭此开关或禁用插件时会恢复默认效果',
    cache: '缓存',
