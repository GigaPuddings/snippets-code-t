export default {
  ...
  localAi: {
    ...
    ragSearching: '正在检索知识库笔记...',
    ragSourcesUsed: '本次回答引用的笔记',
    ragNoResults: '未检索到相关笔记',
    noteToolsTitle: '笔记工具',
    noteToolsEnabled: '笔记工具已开启',
    noteToolsDisabled: '笔记工具已关闭',
    toolCalling: '正在调用笔记工具...',
    toolCallConfirmTitle: '确认笔记操作',
    toolCallCreate: 'AI 请求创建笔记',
    toolCallEdit: 'AI 请求编辑笔记',
    toolCallDelete: 'AI 请求删除笔记',
    toolCallConfirm: '执行',
    toolCallDeny: '拒绝',
    toolCallSuccess: '操作成功',
    toolCallFailed: '操作失败',
    toolCallDenied: '已拒绝操作',
    toolCallStatusPending: '等待确认',
    toolCallStatusExecuting: '执行中',
    toolCallStatusSuccess: '已完成',
    toolCallStatusError: '执行出错',
    toolCallStatusDenied: '已拒绝',
    jumpToLatest: '回到底部',
