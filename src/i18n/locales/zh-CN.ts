export default {
  ...
  localAi: {
    ...
    webSearch: '网页搜索',
    webSearchPluginDesc: '使用搜索引擎插件在系统浏览器中搜索当前输入',
    webSearchNeedsQuery: '请先输入要搜索的内容',
    webSearchPluginUnavailable: '请先在插件市场安装并启用“搜索引擎”插件。',
    webSearchPluginNoDefault:
      '搜索引擎插件未配置默认引擎，请先到插件设置中选择。',
    webSearchPluginFailed: '打开网页搜索失败',
    jumpToLatest: '回到底部',
