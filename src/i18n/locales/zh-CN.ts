export default {
  ...
  localAi: {
    ...
    knowledgeBaseEnabled: '知识库检索已开启',
    knowledgeBaseDisabled: '知识库检索已关闭',
    knowledgeBaseSearching: '正在从知识库中检索相关片段...',
    knowledgeBaseUsed: '本次回答引用的知识库片段',
    knowledgeBaseEmpty: '知识库中没有检索到相关片段，将基于模型自身知识回答。',
    knowledgeBaseNoQuery: '没有可用于检索的问题内容。',
    saveAsFragment: '保存为片段',
    saveAsNote: '保存为笔记',
    saveFragmentTitle: '保存到知识库',
    saveFragmentDesc: '将 AI 回答保存为代码片段或笔记，方便后续检索。',
    fragmentTitle: '标题',
    fragmentCategory: '分类',
    fragmentType: '类型',
    fragmentTypeCode: '代码片段',
    fragmentTypeNote: '笔记',
    saveFragmentSuccess: '已保存到知识库',
    saveFragmentFailed: '保存失败',
    referenceFragment: '引用片段',
    referenceFragmentTitle: '引用知识库片段',
    referenceFragmentDesc: '选择一个片段，其内容将作为上下文随本次提问发送给 AI。',
    referenceFragmentSearch: '搜索片段标题或内容...',
    referenceFragmentEmpty: '没有找到匹配的片段',
    referenceFragmentLoading: '正在搜索...',
    noFragmentSelected: '请先选择一个片段',
    webSearch: '联网搜索',
    webSearchDesc:
