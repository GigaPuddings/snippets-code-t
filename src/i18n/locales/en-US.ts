export default {
  ...
  localAi: {
    ...
    knowledgeBaseEnabled: 'Knowledge base retrieval is on',
    knowledgeBaseDisabled: 'Knowledge base retrieval is off',
    knowledgeBaseSearching: 'Searching knowledge base for relevant snippets...',
    knowledgeBaseUsed: 'Knowledge base snippets referenced in this response',
    knowledgeBaseEmpty:
      'No relevant snippets found in the knowledge base. The model will answer from its own knowledge.',
    knowledgeBaseNoQuery: 'There is no question content to search for.',
    saveAsFragment: 'Save as snippet',
    saveAsNote: 'Save as note',
    saveFragmentTitle: 'Save to knowledge base',
    saveFragmentDesc:
      'Save the AI response as a code snippet or note for future retrieval.',
    fragmentTitle: 'Title',
    fragmentCategory: 'Category',
    fragmentType: 'Type',
    fragmentTypeCode: 'Code snippet',
    fragmentTypeNote: 'Note',
    saveFragmentSuccess: 'Saved to knowledge base',
    saveFragmentFailed: 'Save failed',
    referenceFragment: 'Reference snippet',
    referenceFragmentTitle: 'Reference a knowledge base snippet',
    referenceFragmentDesc:
      'Select a snippet; its content will be sent as context with your message.',
    referenceFragmentSearch: 'Search snippet title or content...',
    referenceFragmentEmpty: 'No matching snippets found',
    referenceFragmentLoading: 'Searching...',
    noFragmentSelected: 'Please select a snippet first',
