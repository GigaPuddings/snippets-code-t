export default {
  ...
  wallpaperSwitcher: {
    ...
    select: 'Select',
    scan: 'Scan',
    folderOrder: 'Folder rotation',
    sequential: 'Sequential',
    randomNoRepeat: 'Random (no repeats per cycle)',
    sortBy: 'Sort by',
    sortFileNameAscending: 'File name (ascending)',
    sortFileNameDescending: 'File name (descending)',
    sortModifiedAscending: 'Modified (oldest first)',
    sortModifiedDescending: 'Modified (newest first)',
    hot: 'Hot',
    toplist: 'Toplist',
    favorites: 'Favorites',
    hotWithLabel: 'Hot',
