export default {
  ...
  settings: {
    ...
    attachment: {
      ...
      defaultImageScale: 'Default Image Scale',
      defaultImageScaleHint:
        'Scale new images relative to their natural size while keeping them inside the editor',
      responsiveImages: 'Fit Images to Editor',
    ...
    gitSync: {
      ...
      branch: {
        title: 'Sync Branch',
        desc: 'Switch when another branch is detected.',
        mainLabel: '{branch} (main)',
        targetBranch: 'target',
        selectTitle: 'Choose Branch',
        switchAndSync: 'Switch & Sync',
        selectMessageEmpty: 'Select a branch to sync',
      ...
      records: {
        title: 'Git Records',
        desc: 'Last 10 commits. Restore files.',
        refresh: 'Refresh',
        synced: 'Synced',
        pendingPush: 'Pending Push',
        loading: 'Loading records...',
        empty: 'No Git records',
  ...
  darkMode: {
    ...
    sunCalcTitle: 'Calculation',
    sunCalcSource: 'Source',
    sunCalcCoordinates: 'Coordinates',
    sunCalcTimezoneOffset: 'TZ Offset (min)',
    sunCalcSunset: 'Switch Sunset',
    sunCalcError: 'Error',
    sunCalcManualLocation: 'Manual ({city})',
    sunCalcAutoLocation: 'Auto ({city})'
  },
  ...
  pin: {
    ...
    ocrPreviewAlt: 'OCR Preview',
    originalImageAlt: 'Original Image',
    ocrSourceAlt: 'OCR Source',
    recognizing: 'Recognizing',
    recognizeFailed: 'Recognition Failed',
    ocrMeasureFailed: 'Unable to create text measurement canvas',
    ...
    nativeTextSelectionHint:
      'Drag to select text directly on the image; Ctrl+A to select all',
  ...
  wallpaperSwitcher: {
    ...
    titleSubtitle: 'Desktop appearance workspace',
    ...
    fixedImageCaption: 'Keep one image',
    localFolder: 'Local folder',
    localFolderCaption: 'Rotate your library',
    systemSettings: 'Windows Settings',
    wallhavenOnline: 'Wallhaven Online',
    wallhavenCaption: 'Discover online',
    stepOne: 'Step 1 · Source',
    chooseSource: 'Choose wallpaper source',
    ready: 'Ready',
    localLibrary: 'Local library',
    folderPath: 'Wallpaper folder',
    imagePath: 'Image file',
    change: 'Change',
    onlineSourceHint: 'Automatically fetch high-resolution wallpapers',
    browseOnline: 'Browse online library',
    browseOnlineHint: 'Search, preview, and apply instantly',
    fixedModeHint: 'Stop rotation and keep this wallpaper',
    selectImage: 'Select image',
    select: 'Select',
    scan: 'Scan',
    folderCreateTimeHint: 'Switches in image creation time order',
    hot: 'Hot',
    toplist: 'Toplist',
    favorites: 'Favorites',
    hotWithLabel: 'Hot',
    ...
    stepTwo: 'Step 2 · Automation',
    automationTitle: 'Automatic switching',
    automationHint: 'Keep your desktop fresh on your schedule',
    enableSchedule: 'Scheduled switching',
    scheduleRunning: 'Auto switch is running',
    schedulePaused: 'Auto switch is paused',
    interval: 'Interval',
    every: 'Every',
    minutes: 'minutes',
    ...
    random: 'Random',
    folderSortLabel: 'Sort by',
    folderSort: {
      createdAscending: 'Date created',
      fileNameAscending: 'File name',
      modifiedDescending: 'Recently modified'
    },
    type: 'Type',
    autoRestore: 'Restore scheduled task on startup',
    autoRestoreShort: 'Resume on launch',
    autoRestoreHint: 'Continue automatic switching next time',
    trayQuickSwitch: 'Tray quick switch',
    trayQuickSwitchHint:
      'Right-click the tray to switch without opening this window',
    cache: 'Cache',
    ...
    setting: 'Setting',
    set: 'Set',
    preparingDownload: 'Connecting to source',
    waitingForSize: 'Getting file size',
    downloadReady: 'Download complete',
    downloadedSize: '{size} received',
    downloading: 'Downloading',
    download: 'Download',
    page: 'Page {page}',
    ...
    placeholders: {
      ...
      folder: 'E:\\Wallpapers',
      selectFolder: 'Choose a folder containing images',
  ...
  update: {
    ...
    downloading: 'Downloading',
    downloadComplete: 'Installer downloaded and cached.',
    cachedInstallerReady: 'Installer is cached. Choose when to install.',
    ...
    installScheduledOnRestart:
      'Update will install automatically the next time the app starts.',
    readyToDownload: '{version} is available to download.',
  ...
  contextMenu: {
    ...
    moreTableActions: 'More Table Actions',
  ...
  screenRecorder: {
    ...
    trimTitle: 'Trim recording',
    trimHint: 'Drag the yellow handles to choose the section to keep',
    trimPreview: 'Trim preview',
    trimPreparing: 'Preparing trim preview...',
    previewUnavailable:
      'Preview is unavailable; the selected range can still be exported',
    trimDuration: 'Duration',
    previewCurrentTime: 'Current preview time',
    trimStart: 'Trim start',
    trimEnd: 'Trim end',
    playPreview: 'Play preview',
    pausePreview: 'Pause preview',
    discardClip: 'Discard and record again',
    copyClip: 'Copy to clipboard',
    copiedClip: 'GIF copied to clipboard',
    ...
    folder: 'Folder',
    again: 'Again',
    savedWithAudio: 'Saved · On',
    savedWithoutAudio: 'Saved · Off',
  ...
  localAi: {
    ...
    openChat: 'Open Chat',
    chatTitle: 'AI Chat',
    chatPrivacySubtitle: 'Privacy-first, unrestricted, always available',
    chatSubtitle: 'Offline model chat, translation, and assistance',
    chatEmpty: 'Start by typing a message',
    chatPlaceholder: 'Describe your goal, context, and desired outcome…',
    inputHint: 'Enter · Shift+Enter',
    privateWorkspace: 'Private local workspace',
    chatWelcomeTitle: 'What would you like to accomplish?',
    chatWelcomeDesc:
      'Start with a clear goal. I can help organize information, explain code, translate content, or develop an idea.',
    quickStart: 'Quick start',
    quickStartHint: 'Choose a common task, then add your details',
    composerLabel: 'Message',
    privateLocalHint: 'Conversations are processed by your local model',
    dragDropHint: 'Drop files or paste images',
    newChat: 'New Chat',
    ...
    onDemandHint: 'Starts on demand when sending',
    now: 'just now',
    quickPromptSummary: 'Summarize this content',
    quickPromptSummaryDesc: 'Extract key points, conclusions, and actions',
    quickPromptTranslate: 'Translate and keep Markdown',
    quickPromptTranslateDesc: 'Preserve tone, structure, and formatting',
    quickPromptCode: 'Explain this code',
    quickPromptCodeDesc: 'Walk through logic, dependencies, and risks',
    quickPromptRegex: 'Generate a regular expression',
    quickPromptRegexDesc: 'Build a pattern with practical examples',
    ...
    previousVersion: 'Previous response version',
    nextVersion: 'Next response version',
    messageVersion: 'Response version {current}/{total}',
    branchChat: 'Branch',
    branchCreated: 'Branched chat created',
    like: 'Like',
    dislike: 'Dislike',
    outputLabel: 'Output',
    ...
    attachmentLimit: 'You can add up to 5 attachments.',
    ...
    textFileTooLarge: 'Text files over 1 MB cannot be parsed.',
    imageTooLarge: 'Images over 5 MB cannot be sent.',
    visionUnavailable:
      'Vision is not enabled or mmproj is not configured, so images cannot be recognized.',
    ...
    mmprojModel: 'mmproj',
    mainModelConfigured: 'Main model configured',
    mmprojConfigured: 'mmproj configured',
