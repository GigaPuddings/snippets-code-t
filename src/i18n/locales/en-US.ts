...
knowledgeBaseEnabled: 'Knowledge base retrieval enabled',
knowledgeBaseDisabled: 'Knowledge base retrieval disabled',
ragSearching: 'Searching knowledge base notes...',
ragSourcesUsed: 'Notes referenced in this answer',
ragNoResults: 'No relevant notes found',
noteToolsTitle: 'Note tools',
noteToolsEnabled: 'Note tools enabled',
noteToolsDisabled: 'Note tools disabled',
toolCalling: 'Calling note tools...',
toolCallConfirmTitle: 'Confirm note operation',
toolCallCreate: 'AI requests to create a note',
toolCallEdit: 'AI requests to edit a note',
toolCallDelete: 'AI requests to delete a note',
toolCallConfirm: 'Execute',
toolCallDeny: 'Deny',
toolCallSuccess: 'Operation succeeded',
toolCallFailed: 'Operation failed',
toolCallDenied: 'Operation denied',
toolCallStatusPending: 'Pending confirmation',
toolCallStatusExecuting: 'Executing',
toolCallStatusSuccess: 'Completed',
