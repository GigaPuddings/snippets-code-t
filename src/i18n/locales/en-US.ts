  ...
  settings: {
    ...
    developer: {
      ...
      openLogs: 'Open Log Folder',
        ...
        hint: 'The report includes app version, build mode, data and plugin directories, window state, frontend errors, and backend log tails. Git tokens are excluded.',
