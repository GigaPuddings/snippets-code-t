export default {
  ...
  settings: {
    ...
    markdownEditorDesc: 'Configure rich text source preview and code snippet editing in one place',
    markdownShowLineNumbers: 'Show line numbers',
    markdownShowLineNumbersDesc: 'Show line numbers in the Markdown source view',
    markdownIndentWithTab: 'Tab indentation',
    markdownIndentWithTabDesc: 'Use Tab to insert indentation in Markdown source and code editors',
    markdownTabSize: 'Indent size',
    markdownTabSizeDesc: 'Set how many spaces a Tab inserts',
    exitApp: 'Exit App',
