export default {
  ...
  settings: {
    ...
    developer: {
      ...
      mode: 'Developer Mode',
      modeDesc: 'Record additional frontend debug logs. Disable it after production troubleshooting.',
      refresh: 'Refresh Diagnostics',
      copy: 'Copy Report',
      openLogs: 'Open Log Folder',
      clearFrontend: 'Clear Frontend Logs',
      hint: 'The report includes app version, build mode, data and plugin directories, window state, frontend errors, and backend log tails. Sensitive credentials such as Git tokens are redacted automatically.',
  ...
  searchPreview: {
    ...
    copyMarkdownCode: 'Copy Markdown Code Block',
    copyVsCodeSnippet: 'Copy VS Code Snippet',
