...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    Category: typeof import('./../pages/config/components/Category.vue')['default']
    ...
    Content: typeof import('./../pages/config/components/Content.vue')['default']
    ContentItem: typeof import('./../components/ContentItem/index.vue')['default']
    ContentList: typeof import('./../pages/config/components/ContentList.vue')['default']
