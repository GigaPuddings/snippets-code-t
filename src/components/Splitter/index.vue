<template>
  <div class="splitter-container" ref="splitterRef">
    ...
    <div class="splitter-divider" @mousedown="startResize" :style="{ left: computedWidth }">
...
const computedWidth = computed(() => {
  return isPercentage.value ? `${firstPanelWidth.value}%` : `${firstPanelWidth.value}px`
})
...
.splitter-divider {
  @apply absolute w-[1px] h-full bg-gray-200 cursor-col-resize z-10 hover:bg-blue-200;
}

.splitter-divider-line {
  @apply absolute top-1/2 -translate-y-1/2 -translate-x-1/2 left-[1px] w-[2px] h-4 bg-gray-300 cursor-col-resize z-10 hover:bg-blue-200;
}
</style>
