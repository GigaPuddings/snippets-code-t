...
import { editCategory, deleteCategory, getCategories } from '@/database/category'
...
const menu = [ { label: '编辑', type: 'edit'}, { label: '删除', type: 'delete'} ]
...
const handleEditCategory = async () => {
  console.log('sub_category', props.category)
  // 保存编辑的分类
