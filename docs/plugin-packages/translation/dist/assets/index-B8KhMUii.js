import { b as Pt, d as Ne, _ as wt, u as kt, n as St, o as Et, q as $t, r as Nt, s as Ct, v as It, w as Rt, k as lt, l as f, x as xt, y as Dt, f as O, h as ct, z as Ot, A as dt, B as Mt, C as zt, D as At, F as Lt, G as Ft, H as Vt, e as Tt, I as fe, J as pe, K as Ut, E as jt, m as x, j as Bt, L as Wt, M as Kt, N as Ce, O as Ke, P as Ht, Q as Gt, R as Zt, S as He } from "./_plugin-vue_export-helper-CKv_N83a.js";
import { I as ut, c as H, d as de, k as C, z as Jt, A as Ge, a as $, o as _, e as I, n as A, u as h, q as l, B as Q, g as ze, s as v, b as U, v as Y, y as Qt, C as Xt, D as Yt, E as qt, r as L, G as es, H as K, J as ts, x as ce, K as Be, t as Ie, L as ss, l as Ze, M as ns, N as as, w as is, O as Je, P as ft, Q as os, f as rs, F as Qe, h as Xe, R as me } from "./runtime-entry-DtonpMUQ.js";
...
}), he = /* @__PURE__ */ lt(ys, [["__scopeId", "data-v-9497085f"]]);
/*!
 * pinia v2.3.1
 ...
 */
let ae;
const _e = (e) => ae = e, vs = process.env.NODE_ENV !== "production" ? Symbol("pinia") : (
...
function pt(e, t) {
  for (const s in t) {
    ...
    if (!(s in e))
      continue;
    const i = e[s];
    G(i) && G(n) && !ce(n) && !Be(n) ? e[s] = pt(i, n) : e[s] = n;
  }
  return e;
}
const mt = () => {
...
function Ae(e, t) {
  ...
  for (const s in t) {
    if (!t.hasOwnProperty(s))
      continue;
    const n = t[s], i = e[s];
    G(i) && G(n) && e.hasOwnProperty(s) && !ce(n) && !Be(n) ? e[s] = Ae(i, n) : e[s] = n;
  }
  return e;
}
...
function Le(e, t, s = {}, n, i, r) {
  ...
  const P = (a, o = "") => {
    ...
    const g = function() {
      ...
      let ne;
      try {
        ne = a.apply(this && this.$id === e ? this : p, w);
      } catch (M) {
        throw X(N, M), M;
      }
      return ne instanceof Promise ? ne.then((M) => (X(T, M), M)).catch((M) => (X(N, M), Promise.reject(M))) : (X(T, ne), ne);
    };
    ...
    $dispose: d
  }, p = es(process.env.NODE_ENV !== "production" || process.env.NODE_ENV !== "production" && process.env.NODE_ENV !== "test" && ie ? z(
    {
      _hmrPayload: D,
  ...
  for (const a in V) {
    const o = V[a];
    if (ce(o) && !et(o) || Be(o))
      process.env.NODE_ENV !== "production" && i ? ge(B.value, a, Ie(V, a)) : r || (F && Ps(o) && (ce(o) ? o.value = F[a] : Ae(o, F[a])), n.state.value[e][a] = o), process.env.NODE_ENV !== "production" && D.state.push(a);
      ...
      // @ts-expect-error
      s.getters[a]
    ) : o, ie && (V._getters || // @ts-expect-error: same
    (V._getters = K([]))).push(a));
  }
...
function ws(e, t, s) {
  ...
  function c(m, y) {
    ...
    (process.env.NODE_ENV === "test" && ae && ae._testing ? null : m) || (E ? Xt(vs, null) : null), m && _e(m), process.env.NODE_ENV !== "production" && !ae)
      throw new Error(`[🍍]: "getActivePinia()" was called but there was no active Pinia. Are you trying to use a store before calling "app.use(pinia)"?
See https://pinia.vuejs.org/core-concepts/outside-component-usage.html for help.
This will fail in production.`);
    m = ae, m._s.has(n) || (r ? Le(n, t, i, m) : tt(n, i, m), process.env.NODE_ENV !== "production" && (c._pinia = m));
    const u = m._s.get(n);
...
const be = ht, Is = be.map((e) => e.id), yt = be.reduce((e, t) => (e[t.id] = t.enabledByDefault, e), {}), Rs = (e) => Is.includes(e), q = [], ee = [
  { id: "attachment", labelKey: "settings.attachment.menu", icon: ls }
], Fe = {
  attachment: ft(() => import("./index-DRZJLmUi.js"))
}, te = [], ye = [], Ve = [], Te = [], Ue = [], oe = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map(), we = /* @__PURE__ */ new Map(), xs = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Map(), se = /* @__PURE__ */ new Map(), ke = /* @__PURE__ */ new Set(), Se = /* @__PURE__ */ new Set(), $e = (e) => e.replace(/^[\\/]+|[\\/]+$/g, ""), Ds = (e) => !!e && !e.includes("://") && !e.startsWith("/") && !/^[a-zA-Z]:[\\/]/.test(e) && !$e(e).split(/[\\/]+/).includes(".."), Os = (e, t) => {
  if (!e.packagePath)
  ...
  const s = ue(e, t), n = await fetch(s);
  if (!n.ok)
    throw new Error(
  ...
  registerSettingsTab(t) {
    ...
    r === -1 ? (ee.push(n), Fe[t.id] = c, ke.add(i)) : ke.has(i) && (ee[r] = n, Fe[t.id] = c), Me(e, "settingsTabs", t.id);
  },
  registerSearchProvider(t) {
    ...
    n === -1 ? q.push(s) : q[n] = s, Me(e, "searchSources", t.source);
  },
  ...
  const { activateOfficialLocalPlugin: t } = await import("./official-runtime--VQwJWZq.js");
  return t(e);
}, Xs = async (e) => !1, Ys = (e) => {
  ...
  const s = t.map((n) => {
    ...
    return i.rel = "stylesheet", i.href = ue(e, n), i.dataset.pluginId = String(e.id), document.head.appendChild(i), i;
  });
  ...
  for (const s of e)
    if (s.source === "local" && t(String(s.id)) && !oe.has(String(s.id))) {
      if (s.manifest.entry?.frontend) {
        try {
          ...
          await Js(s, n), oe.add(String(s.id));
        } catch (n) {
          le(String(s.id)), f.warn(`[PluginRuntime] 加载本地插件失败: ${s.id}`, n);
          try {
            await Qs(
              je(s)
            ) && (oe.add(String(s.id)), f.warn(
              `[PluginRuntime] 已回退到内置官方插件运行时: ${s.id}`
            ));
          } catch (i) {
            le(String(s.id)), f.warn(
...
function le(e) {
  ...
  for (let t = ee.length - 1; t >= 0; t -= 1) {
    ...
    s.pluginId === e && ke.has(n) && (delete Fe[s.id], ee.splice(t, 1), ke.delete(n));
  }
...
const at = (e) => e.replace(/^v/i, "").split(".").map((t) => Number.parseInt(t, 10)).map((t) => Number.isFinite(t) ? t : 0), tn = (e, t) => {
  ...
  actions: {
    ...
    async setEnabled(e, t) {
      ...
      this.enabled[e] = t;
      try {
        f.info("[PluginStore] set enabled start", { pluginId: e, enabled: t }), t || (le(String(e)), this.runtimeRevision += 1), await Mt(e, t), await this.reconcileInstalledPlugins(
          "set-enabled",
          t ? [] : [String(e)]
  ...
  setup(e) {
    const { t } = Tt(), s = nn(), n = ["translation-offline-runtime", "translation"], i = L("bing"), r = L(!1), c = L(!1), m = L({ isCached: !1, cacheType: "none" }), y = L(!1), E = L(!1), u = L(!1), k = L(!1), b = L([]), S = C(() => m.value.isCached), F = C(() => [
      ...
      try {
        ...
        y.value = !1, He(null), r.value = pe(), m.value = await fe(), f.info(`[翻译设置] 最终状态 - 内存加载: ${r.value}, 缓存存在: ${m.value.isCached}`);
      }
    }, We = async () => {
...
}), ga = /* @__PURE__ */ lt(ma, [["__scopeId", "data-v-1a70fd71"]]), va = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ga
