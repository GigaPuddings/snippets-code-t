import { b as bt, d as Ne, _ as Pt, u as wt, n as kt, o as St, q as Et, r as $t, s as Nt, v as Ct, w as It, k as rt, l as m, x as Rt, y as xt, f as D, h as lt, z as Dt, A as ct, B as Ot, C as Mt, D as zt, F as At, G as Lt, H as Ft, e as Vt, I as ue, J as fe, K as Tt, E as Ut, m as M, j as jt, L as Bt, M as Wt, N as Kt, O as We, P as Ht, Q as Gt, R as Zt, S as Ke } from "./_plugin-vue_export-helper-Bux2Si-R.js";
import { I as dt, c as H, d as ce, k as C, z as Jt, A as He, a as $, o as _, e as I, n as A, u as g, q as l, B as Q, g as Me, s as v, b as U, v as Y, y as Qt, C as Xt, D as Yt, E as qt, r as L, G as es, H as K, J as ts, x as le, K as je, t as Ce, L as ss, l as Ge, M as ns, N as as, w as is, O as Ze, P as ut, Q as os, f as rs, F as Je, h as Qe, R as pe } from "./runtime-entry-kBP_wtmk.js";
...
const be = ht, Is = be.map((e) => e.id), gt = be.reduce((e, t) => (e[t.id] = t.enabledByDefault, e), {}), Rs = (e) => Is.includes(e), ge = [], q = [
  ...
  attachment: ut(() => import("./index-CUD7GQiP.js"))
  ...
  const { activateOfficialLocalPlugin: t } = await import("./official-runtime-BPzTq2Yn.js");
  return t(e);
}, Xs = async (e) => !1, Ys = (e) => {
  ...
  setup(e) {
    const { t } = Vt(), s = nn(), n = ["translation-offline-runtime", "translation"], i = L("bing"), r = L(!1), c = L(!1), p = L({ isCached: !1, cacheType: "none" }), y = L(!1), E = L(!1), u = L(!1), w = L(!1), b = L([]), k = C(() => p.value.isCached), F = C(() => [
      ...
      try {
        ...
        }), r.value = !1, M.msg(a instanceof Error && a.message ? a.message : t("translation.modelLoadFailed"), "error");
      } finally {
      ...
      try {
        ...
        m.error("[翻译设置] 模型激活失败:", a), r.value = !1, M.msg(a instanceof Error && a.message ? a.message : t("translation.modelLoadFailed"), "error");
      } finally {
...
}), ha = /* @__PURE__ */ rt(ma, [["__scopeId", "data-v-32768361"]]), va = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ha
