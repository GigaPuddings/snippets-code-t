import { aw as a, ax as C, f as i, h as L, ay as P, x as S, az as O, aA as o } from "./_plugin-vue_export-helper-BykmhDAa.js";
class x {
  constructor(...e) {
...
class w {
  ...
  toLogical(e) {
    return this.position instanceof D ? this.position : this.position.toLogical(e);
  }
  toPhysical(e) {
...
class d extends C {
  ...
  static async fromPath(e) {
    return i("plugin:image|from_path", { path: e }).then((n) => new d(n));
  }
...
function A() {
  return new f(window.__TAURI_INTERNALS__.metadata.currentWindow.label, {
    // @ts-expect-error `skip` is not defined in the public API but it is handled by the constructor
    skip: !0
  });
}
async function y() {
  return i("plugin:window|get_all_windows").then((t) => t.map((e) => new f(e, {
    // @ts-expect-error `skip` is not defined in the public API but it is handled by the constructor
    skip: !0
  })));
}
...
class f {
  ...
  constructor(e, n = {}) {
    var l;
    this.label = e, this.listeners = /* @__PURE__ */ Object.create(null), n?.skip || i("plugin:window|create", {
      options: {
        ...n,
