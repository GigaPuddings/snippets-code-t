import { w as rt, u as d, k as m, C as at, r as nt, ar as it, a7 as ot, d as _, b as A, o as y, v as F, a as C, e as D, F as st, g as R, n as P, y as I, m as ft, Z as ut, G as ct, t as O, z as ht } from "./runtime-entry-CxfepRbR.js";
import { a0 as lt, bn as dt, $ as gt, a1 as bt, a2 as Y, b as vt, d as pt, bg as yt, b9 as W, Y as mt, u as z, _ as J, v as U, w as kt, c as xt } from "./_plugin-vue_export-helper-Kpx6kpKo.js";
const Q = Symbol("buttonGroupContextKey"), St = ({ from: r, replacement: e, scope: t, version: a, ref: n, type: i = "API" }, o) => {
  rt(() => d(o), (s) => {
...
`);
  ...
  const t = at(Q, void 0), a = dt("button"), { form: n } = gt(), i = bt(m(() => t?.size)), o = Y(), s = nt(), u = it(), g = m(() => r.type || t?.type || ""), v = m(() => {
    var f, x, w;
...
function Et(r) {
  ...
  return typeof r == "string" && (r = Vt(r)), typeof r == "object" && (b(r.r) && b(r.g) && b(r.b) ? (e = _t(r.r, r.g, r.b), o = !0, s = String(r.r).substr(-1) === "%" ? "prgb" : "rgb") : b(r.h) && b(r.s) && b(r.v) ? (a = H(r.s), n = H(r.v), e = Ft(r.h, a, n), o = !0, s = "hsv") : b(r.h) && b(r.s) && b(r.l) && (a = H(r.s), i = H(r.l), e = Tt(r.h, a, i), o = !0, s = "hsl"), Object.prototype.hasOwnProperty.call(r, "a") && (t = r.a)), t = X(t), {
    ok: o,
    format: r.format || s,
...
var Gt = (
  ...
  function() {
    ...
    return r.prototype.isDark = function() {
      ...
      return this.a = X(e), this.roundA = Math.round(100 * this.a) / 100, this;
...
const jt = _({
  ...
  setup(r, { expose: e, emit: t }) {
    const a = r, n = zt(a), i = z("button"), { _ref: o, _size: s, _type: u, _disabled: g, _props: v, shouldAddSpace: M, handleClick: T } = Mt(a, t), j = m(() => [
      i.b(),
      i.m(u.value),
      i.m(s.value),
    ...
    return e({
      ...
      default: F(() => [
        f.loading ? (y(), C(st, { key: 0 }, [
          f.$slots.loading ? R(f.$slots, "loading", { key: 0 }) : (y(), A(d(U), {
            key: 1,
        ...
        ], 64)) : f.icon || f.$slots.icon ? (y(), A(d(U), { key: 1 }, {
          default: F(() => [
...
var Ot = /* @__PURE__ */ J(Dt, [["__file", "button.vue"]]);
const Wt = {
  size: V.size,
  type: V.type
}, Ut = _({
...
var tt = /* @__PURE__ */ J(qt, [["__file", "button-group.vue"]]);
const Zt = kt(Ot, {
  ButtonGroup: tt
});
xt(tt);
