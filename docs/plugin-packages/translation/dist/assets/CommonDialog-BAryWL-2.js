import { b as J, u as Q, d as K, b9 as pe, b3 as F, _ as se, Z as ye, bh as Ce, v as be, bf as ge, aX as Ee, U as ne, a7 as he, bi as ae, ap as x, bj as Te, bk as we, am as Se, bl as ke, bm as De, b1 as ee, bn as Be, bo as Le, bp as Me, bq as oe, br as Ae, bs as Ie, w as Oe, k as $e } from "./_plugin-vue_export-helper-BykmhDAa.js";
import "./index-B4rGDAfW.js";
import { $ as j, d as z, c as N, Q as Ne, g, f as re, U as Ye, a0 as Re, C as te, k as S, a as q, o as $, q as Y, e as W, n as T, u as o, s as Z, v as b, b as G, y as _e, B as ie, x as de, w as X, N as Ve, D as ze, r as w, l as He, ar as Ue, Z as Xe, a3 as Pe, a1 as Ke, m as Ge, an as ue, a2 as je, R as le } from "./runtime-entry-yPFnsQUl.js";
import { c as qe, u as Fe, E as We } from "./refs-DmQCjF3r.js";
...
const ce = (e) => {
  if (!e)
    return { onClick: j, onMousedown: j, onMouseup: j };
  let n = !1, r = !1;
  return { onClick: (d) => {
    n && r && e(d), n = r = !1;
  }, onMousedown: (d) => {
...
var xe = z({
  ...
  setup(e, { slots: n, emit: r }) {
    ...
    return () => e.mask ? N("div", {
      ...
      onMousedown: d,
      onMouseup: f
    }, [g(n, "default")], P.STYLE | P.CLASS | P.PROPS, ["onClick", "onMouseup", "onMousedown"]) : Ne("div", {
...
const eo = xe, fe = Symbol("dialogInjectionKey"), me = J({
  ...
  const a = (t) => {
    const v = t.clientX, y = t.clientY, { offsetX: C, offsetY: m } = s, p = e.value.getBoundingClientRect(), h = p.left, u = p.top, R = p.width, k = p.height, H = document.documentElement.clientWidth, U = document.documentElement.clientHeight, _ = -h + C, D = -u + m, B = H - h - R + C, L = U - u - k + m, M = (l) => {
      let I = C + l.clientX - v, V = m + l.clientY - y;
      c?.value || (I = Math.min(Math.max(I, _), B), V = Math.min(Math.max(V, D), L)), s = {
        offsetX: I,
        offsetY: V
  ...
  setup(e, { expose: n }) {
    const r = e, { t: c } = ye(), { Close: s } = Ce, { dialogRef: a, headerRef: d, bodyId: f, ns: i, style: t } = te(fe), { focusTrapRef: v } = te(ge), y = S(() => [
      ...
      { [i.m("center")]: r.center }
    ]), C = qe(v, a), m = S(() => r.draggable), p = S(() => r.overflow), { resetPosition: h } = to(a, d, m, p);
    return n({
      resetPosition: h
    }), (u, R) => ($(), q("div", {
      ref: o(C),
...
const ao = J({
  ...
  return X(() => e.modelValue, (E) => {
    E ? (v.value = !1, _(), y.value = !0, C.value = Me(e.zIndex) ? a() : C.value++, He(() => {
    ...
    e.modelValue && (t.value = !0, y.value = !0, _());
  }), {
    afterEnter: k,
    afterLeave: H,
    beforeLeave: U,
