import { b as wt, d as Ne, _ as kt, u as St, n as Et, o as $t, q as Nt, r as Ct, s as It, v as Rt, w as xt, k as lt, l as f, x as Dt, y as Ot, f as O, h as ct, z as Mt, A as dt, B as zt, C as At, D as Lt, F as Ft, G as Vt, H as Tt, e as Ut, I as fe, J as pe, K as jt, E as Bt, m as x, j as Wt, L as Kt, M as Ht, N as Ce, O as We, P as Gt, Q as Zt, R as Jt, S as Ke } from "./_plugin-vue_export-helper-BykmhDAa.js";
import { I as ut, c as H, d as ue, k as C, z as Qt, A as He, a as $, o as _, e as I, n as A, u as h, q as l, B as Q, g as Me, s as v, b as U, v as Y, y as Xt, C as Yt, D as qt, E as es, r as L, G as ts, H as K, J as ss, x as de, K as je, t as Ie, L as ns, l as Ge, M as as, N as is, w as os, O as Ze, P as ft, Q as rs, f as ls, F as Je, h as Qe, R as me } from "./runtime-entry-yPFnsQUl.js";
...
const be = ht, Rs = be.map((e) => e.id), yt = be.reduce((e, t) => (e[t.id] = t.enabledByDefault, e), {}), xs = (e) => Rs.includes(e), q = [], ee = [
  ...
  attachment: ft(() => import("./index-CWQrbXTV.js"))
  ...
  const { activateOfficialLocalPlugin: t } = await import("./official-runtime-kOlSgKHq.js");
  return t(e);
}, tn = async (e) => !1, sn = (e) => {
