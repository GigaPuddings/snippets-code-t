import { q as w } from "./_plugin-vue_export-helper-BxX7cX_q.js";
import { E } from "./dropdown-item-zDqaVQnT.js";
import { I as L, c as n, C as V, d as j, k as N, f as W, p as D, a as i, b as c, e as a, o, u as e, s as r, n as z, v as B, q as G } from "./runtime-entry-C62Reu10.js";
import { u as O, i as I, j as M, k as x } from "./useGitStatus-CN5lumtz.js";
import { L as Z } from "./Loading-DOlPoUwy.js";
...
const q = Symbol(process.env.NODE_ENV !== "production" ? "router" : "");
...
const H = ["title"], K = {
  ...
  setup(t) {
    const p = $(), {
      ...
      stateDescription: b,
      gitSettings: y
    } = O(), k = N(() => !!y.value?.enabled && s.value !== "error"), h = () => {
...
}), tt = /* @__PURE__ */ w(J, [["__scopeId", "data-v-c2d8aaac"]]);
export {
  tt as default
};
