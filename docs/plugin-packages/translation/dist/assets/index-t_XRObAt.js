import { i as q, V as me, b as Ye, W as ie, X as be, Y as xe, Z as Xe, $ as Je, _ as Qe, a0 as et, u as tt, a1 as st, a as pe, a2 as Ce, a3 as nt, a4 as at, a5 as lt, a6 as it, z as Ge, a7 as ot, a8 as rt, a9 as ut, w as ct, q as Se, E as Be, n as De, e as dt, l as B, o as T } from "./_plugin-vue_export-helper-BxX7cX_q.js";
import { I as Le, c as _, d as ce, r as $, G as mt, k as D, w as ue, f as Ae, a5 as gt, a as y, o as d, a1 as ze, e as p, u as e, ag as ve, n as j, g as he, v as L, b as W, an as ft, ac as _e, A as yt, q as a, s as c, x as oe, F as R, h as re, R as K, a3 as pt, a9 as vt } from "./runtime-entry-C62Reu10.js";
import { C as ge } from "./index-DHOB4Bdo.js";
import { C as ht } from "./CommonDialog-CCMFychg.js";
import { u as bt, r as _t, s as Ie, g as St, a as wt, b as Vt, c as Te, d as Pe, e as Ee, f as kt, h as Ct } from "./useGitStatus-CN5lumtz.js";
import { L as $t } from "./Loading-DOlPoUwy.js";
import { E as Nt, i as Gt } from "./index-BLWmBi1y.js";
import { v as Fe } from "./index-immFLjPl.js";
import { C as zt } from "./CloseSmall-CQgezRqx.js";
const It = Le("attention", !0, function(i) {
  ...
  valueOnClear: {
    ...
    validator: (i) => i === null || q(i) || ["min", "max"].includes(i),
    default: null
  },
  name: String,
  placeholder: String,
  ...
  setup(i, { expose: l, emit: g }) {
    const u = i, { t: P } = et(), m = tt("input-number"), S = $(), h = mt({
      ...
      userInput: null
    }), { formItem: A } = st(), w = D(() => q(u.modelValue) && u.modelValue <= u.min), b = D(() => q(u.modelValue) && u.modelValue >= u.max), V = D(() => {
      const s = x(u.step);
    ...
    }, Z = (s, r = 1) => q(s) ? G(s + u.step * r) : h.currentValue, M = () => {
      if (u.readonly || N.value || b.value)
        return;
      const s = Number(I.value) || 0, r = Z(s);
      X(r), g(be, h.currentValue), de();
    }, Y = () => {
      if (u.readonly || N.value || w.value)
        return;
      const s = Number(I.value) || 0, r = Z(s, -1);
      X(r), g(be, h.currentValue), de();
    }, ee = (s, r) => {
      ...
      const r = s !== "" ? Number(s) : "";
      (q(r) && !Number.isNaN(r) || s === "") && X(r), de(), h.userInput = null;
    }, J = () => {
      var s, r;
...
}), Rt = /* @__PURE__ */ Se(Ot, [["__scopeId", "data-v-bd31799c"]]), Wt = { class: "confirm-header" }, jt = { class: "header-title" }, Ht = { class: "confirm-body" }, Kt = { class: "message-text" }, qt = {
  key: 0,
  class: "hint-list"
}, Zt = { class: "confirm-footer" }, Yt = /* @__PURE__ */ ce({
...
const Qt = { class: "settings-panel" }, es = { class: "panel-header" }, ts = { class: "panel-title" }, ss = { class: "panel-content" }, ns = { class: "sync-status-panel__left" }, as = { class: "sync-status-icon" }, ls = { class: "sync-status-info" }, is = { class: "sync-status-label" }, os = { class: "sync-status-detail" }, rs = {
...
}, Hs = { class: "git-record-main" }, Ks = ["title"], qs = { class: "git-record-time" }, Zs = { class: "git-record-meta" }, Ys = {
  key: 0,
  ...
  setup(i) {
    const { t: l } = dt(), {
      ...
      secondaryText: "",
      type: "info"
    }), G = $(!1), x = $(null), Z = $("main"), M = $(!1), Y = $(""), ee = $([]), X = $([]), se = $(!1), fe = $(!1), J = $(!1), ne = $(null), we = D(() => (x.value?.available_branches?.length ? x.value.available_branches : ["main"]).map((n) => ({
...
详情: ${O.slice(0, 100)}${O.length > 100 ? "..." : ""}`), T.msg(Q, "error", "top-right"), console.group(`🔧 Git 错误解决建议 - ${n.title}`), console.log(O), console.log("建议步骤:"), n.suggestions.forEach((o, H) => {
      ...
      x.value = t, Z.value = t.recommended_branch || "main", G.value = !0;
    }, k = (t) => {
