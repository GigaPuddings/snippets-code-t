import { e as ne, f as m, m as h, h as N, g as oe, j as le, E as se, x as re, k as ie } from "./_plugin-vue_export-helper-Bux2Si-R.js";
import { E as ce } from "./switch-DP3RoKAR.js";
import { E as ue } from "./empty-BUlqUMEd.js";
import "./tooltip-l0sNRNKZ.js";
import { I as P, c as n, d as de, r as f, G as me, f as he, p as fe, a as g, o as v, q as u, e as E, u as i, s as y, v as k, b as T, F as B, h as A, n as ve, x as pe } from "./runtime-entry-kBP_wtmk.js";
import "./index-CloiE8PS.js";
import { a as _e } from "./ConfirmDialog-DsB8FePx.js";
import { E as ge } from "./index-COd_6rH_.js";
import { L as ke } from "./Loading-DETndE1u.js";
import { R as we, P as ye } from "./Redo-CdGOEoly.js";
...
const Ee = { class: "w-full h-full overflow-hidden relative" }, $e = {
  key: 0,
  class: "scanning-overlay"
}, be = { class: "scanning-content" }, Le = { class: "scanning-text" }, Ue = { class: "scanning-progress" }, Se = { class: "retrieve-container" }, je = { class: "search-config transparent-input" }, Ie = { class: "config-title" }, ze = { class: "title-text" }, We = { class: "flex gap-4" }, De = { class: "search-list" }, Te = { class: "item-left" }, Be = { class: "icon-wrapper" }, Fe = ["src", "alt", "onError"], Me = { class: "item-center" }, Re = { class: "item-right" }, Ne = /* @__PURE__ */ de({
  __name: "index",
  setup(t) {
    const { t: d } = ne(), a = f([]), x = f([]), w = f(!1), p = f(-1), V = f(null), _ = f(!1), $ = f(""), b = f(0), L = f(0);
    let U = null, S = null;
    const C = me(/* @__PURE__ */ new Map()), j = async (e) => {
      if (e.icon)
        return e.icon;
      if (e.url) {
        if (C.has(e.url))
        ...
        try {
          ...
          return C.set(e.url, s), e.icon = s, s;
        } catch (c) {
      ...
      e.url ? (e.icon = "", C.delete(e.url), await j(e)) : e.icon = "", I();
    }, M = () => {
      I();
    }, I = () => {
      V.value !== null && clearTimeout(V.value), V.value = window.setTimeout(() => {
        z(!1), V.value = null;
      }, 1e3);
    };
    he(async () => {
    ...
    const G = async () => {
      try {
        ...
        !e.completed && e.stage ? (_.value = !0, $.value = e.stage, b.value = e.current, L.value = e.total) : _.value = !1;
      } catch (e) {
        console.error("获取扫描状态失败:", e);
      }
    }, O = async () => {
      U = await N("scan-progress", (e) => {
        _.value = !0, $.value = e.payload.stage, b.value = e.payload.current, L.value = e.payload.total;
...
}), Ye = /* @__PURE__ */ ie(Ne, [["__scopeId", "data-v-8d542fc6"]]);
export {
  Ye as default
};
