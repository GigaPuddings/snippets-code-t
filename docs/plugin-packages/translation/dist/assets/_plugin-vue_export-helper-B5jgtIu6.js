...
var Gl = typeof exports == "object" && exports && !exports.nodeType && exports, os = Gl && typeof module == "object" && module && !module.nodeType && module, Of = os && os.exports === Gl, as = Of ? Mt.Buffer : void 0, wf = as ? as.isBuffer : void 0, Fo = wf || Tf, Cf = "[object Arguments]", Nf = "[object Array]", Sf = "[object Boolean]", Lf = "[object Date]", If = "[object Error]", Af = "[object Function]", Pf = "[object Map]", Rf = "[object Number]", Df = "[object Object]", Mf = "[object RegExp]", kf = "[object Set]", Ff = "[object String]", $f = "[object WeakMap]", Uf = "[object ArrayBuffer]", xf = "[object DataView]", Vf = "[object Float32Array]", Bf = "[object Float64Array]", Wf = "[object Int8Array]", Hf = "[object Int16Array]", jf = "[object Int32Array]", zf = "[object Uint8Array]", Kf = "[object Uint8ClampedArray]", Gf = "[object Uint16Array]", Yf = "[object Uint32Array]", pe = {};
pe[Vf] = pe[Bf] = pe[Wf] = pe[Hf] = pe[jf] = pe[zf] = pe[Kf] = pe[Gf] = pe[Yf] = !0;
pe[Cf] = pe[Nf] = pe[Uf] = pe[Sf] = pe[xf] = pe[Lf] = pe[If] = pe[Af] = pe[Pf] = pe[Rf] = pe[Df] = pe[Mf] = pe[kf] = pe[Ff] = pe[$f] = !1;
function Xf(e) {
...
var $o = Sn(Mt, "DataView"), Uo = Sn(Mt, "Promise"), xo = Sn(Mt, "Set"), fs = "[object Map]", tp = "[object Object]", ds = "[object Promise]", ps = "[object Set]", ms = "[object WeakMap]", vs = "[object DataView]", np = Nn($o), rp = Nn(ur), op = Nn(Uo), ap = Nn(xo), sp = Nn(ko), an = Gn;
($o && an(new $o(new ArrayBuffer(1))) != vs || ur && an(new ur()) != fs || Uo && an(Uo.resolve()) != ds || xo && an(new xo()) != ps || ko && an(new ko()) != ms) && (an = function(e) {
  var t = Gn(e), n = t == tp ? e.constructor : void 0, r = n ? Nn(n) : "";
  if (r)
    switch (r) {
      case np:
        return vs;
...
var gp = 1, _p = 2, hp = "[object Boolean]", yp = "[object Date]", bp = "[object Error]", Ep = "[object Map]", Tp = "[object Number]", Op = "[object RegExp]", wp = "[object Set]", Cp = "[object String]", Np = "[object Symbol]", Sp = "[object ArrayBuffer]", Lp = "[object DataView]", _s = At ? At.prototype : void 0, No = _s ? _s.valueOf : void 0;
...
const kn = (e) => e === void 0, Kr = (e) => typeof e == "boolean", $e = (e) => typeof e == "number", Jb = (e) => !e && e !== 0 || ft(e) && e.length === 0 || dt(e) && !Object.keys(e).length, rt = (e) => typeof Element > "u" ? !1 : e instanceof Element, lm = (e) => Lt(e) ? !Number.isNaN(Number(e)) : !1;
...
Ns[Ss] = Ns[Ss] || {};
var Ls = Object.getOwnPropertySymbols, wm = Object.prototype.hasOwnProperty, Cm = Object.prototype.propertyIsEnumerable, Nm = (e, t) => {
  var n = {};
  for (var r in e)
...
function Bt(e, t, n = {}) {
  const r = n, { window: o = Er } = r, a = Nm(r, ["window"]);
  let s;
...
var Is = Object.getOwnPropertySymbols, Sm = Object.prototype.hasOwnProperty, Lm = Object.prototype.propertyIsEnumerable, Im = (e, t) => {
  var n = {};
  for (var r in e)
    Sm.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r]);
  if (e != null && Is)
    for (var r of Is(e))
...
const yi = (e, t, n = !1) => {
  ...
  return r;
}, Pn = "update:modelValue", bi = "change", tE = "input";
var Oe = (e, t) => {
...
const Ym = "utils/dom/style", Ei = (e = "") => e.split(" ").filter((t) => !!t.trim()), nE = (e, t) => {
  if (!e || !t)
    return !1;
  if (t.includes(" "))
...
usage: app.provide(ID_INJECTION_KEY, {
  ...
  const n = F(void 0), r = t.prop ? n : Ni("size"), o = t.global ? n : Wm(), a = t.form ? { size: void 0 } : ue(ha, void 0), s = t.formItem ? { size: void 0 } : ue(Zr, void 0);
...
const In = 4, Vv = {
  ...
  setup(e) {
    ...
    const p = I(() => Vv[t.vertical ? "vertical" : "horizontal"]), d = I(() => Bv({
      ...
      move: t.move,
      bar: p.value
    })), v = I(() => o.value[p.value.offset] ** 2 / n.wrapElement[p.value.scrollSize] / t.ratio / a.value[p.value.offset]), g = (N) => {
      var E;
...
var Ng = /* @__PURE__ */ Oe(wg, [["render", Cg], ["__file", "focus-trap.vue"]]), Ye = "top", st = "bottom", lt = "right", Xe = "left", Oa = "auto", Tr = [Ye, st, lt, Xe], xn = "start", dr = "end", Sg = "clippingParents", ki = "viewport", Qn = "popper", Lg = "reference", Gs = Tr.reduce(function(e, t) {
...
function zg(e) {
  ...
  if (!(!a || !s)) {
    var p = jg(o.padding, n), d = Ca(a), v = i === "y" ? Ye : Xe, g = i === "y" ? st : lt, m = n.rects.reference[f] + n.rects.reference[i] - s[i] - n.rects.popper[f], T = s[i] - n.rects.reference[i], c = Or(a), h = c ? i === "y" ? c.clientHeight || 0 : c.clientWidth || 0 : 0, C = m / 2 - T / 2, b = p[v], w = h - d[f] - p[g], N = h / 2 - d[f] / 2 + C, E = or(b, N, w), R = i;
...
function t_(e) {
  var t, n = dn(e), r = Sa(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = yn(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = yn(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + La(e), i = -r.scrollTop;
...
function pr(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, s = a === void 0 ? e.strategy : a, l = n.boundary, i = l === void 0 ? Sg : l, u = n.rootBoundary, f = u === void 0 ? ki : u, p = n.elementContext, d = p === void 0 ? Qn : p, v = n.altBoundary, g = v === void 0 ? !1 : v, m = n.padding, T = m === void 0 ? 0 : m, c = Vi(typeof T != "number" ? T : Bi(T, Tr)), h = d === Qn ? Lg : Qn, C = e.rects.popper, b = e.elements[g ? h : d], w = o_(On(b) ? b : b.contextElement || dn(e.elements.popper), i, f, s), N = Bn(e.elements.reference), E = zi({ reference: N, element: C, placement: o }), R = Ko(Object.assign({}, C, E)), D = d === Qn ? R : N, B = { top: w.top - D.top + c.top, bottom: D.bottom - w.bottom + c.bottom, left: w.left - D.left + c.left, right: D.right - w.right + c.right }, X = e.modifiersData.offset;
  if (d === Qn && X) {
    var j = X[o];
...
function l_(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, i = n.fallbackPlacements, u = n.padding, f = n.boundary, p = n.rootBoundary, d = n.altBoundary, v = n.flipVariations, g = v === void 0 ? !0 : v, m = n.allowedAutoPlacements, T = t.options.placement, c = St(T), h = c === T, C = i || (h || !g ? [Ur(T)] : s_(T)), b = [T].concat(C).reduce(function(qe, xe) {
      return qe.concat(St(xe) === Oa ? a_(t, { placement: xe, boundary: f, rootBoundary: p, padding: u, flipVariations: g, allowedAutoPlacements: m }) : xe);
    }, []), w = t.rects.reference, N = t.rects.popper, E = /* @__PURE__ */ new Map(), R = !0, D = b[0], B = 0; B < b.length; B++) {
      var X = b[B], j = St(X), Q = Wn(X) === xn, Le = [Ye, st].indexOf(j) >= 0, me = Le ? "width" : "height", oe = pr(t, { placement: X, boundary: f, rootBoundary: p, altBoundary: d, padding: u }), x = Le ? Q ? lt : Xe : Q ? st : Ye;
      w[me] > N[me] && (x = Ur(x));
      var ge = Ur(x), we = [];
...
Aa();
var N_ = [Hi, Ki, Wi, Fi];
Aa({ defaultModifiers: N_ });
var S_ = [Hi, Ki, Wi, Fi, p_, i_, __, Gg, c_], L_ = Aa({ defaultModifiers: S_ });
...
const K_ = he({
  ...
  if (n === !1 || !a)
    return t?.(o);
}, EE = (e) => (t) => t.pointerType === "mouse" ? e(t) : void 0, r0 = V({
...
const u0 = fn(i0), Xi = () => {
  ...
  setup(e, { expose: t }) {
    ...
    const C = I(() => O(h) ? !0 : O(u)), b = I(() => n.disabled ? !1 : O(u)), w = I(() => n.appendTo || r.value), N = I(() => {
      var x;
...
var L0 = /* @__PURE__ */ Oe(S0, [["__file", "tag.vue"]]);
...
const x0 = (e, t) => {
  ...
  }), { wrapperRef: N, isFocused: E, handleBlur: R } = $v(p, {
    beforeFocus() {
      return oe.value;
    },
    afterFocus() {
  ...
  }, en = Si(), yt = I(() => ["small"].includes(en.value) ? "small" : "default"), Ft = I({
    get() {
  ...
  }, Nr = (S) => dt(S.value) ? Wt(S.value, e.valueKey) : S.value, Wu = I(() => fe.value.filter((S) => S.visible).every((S) => S.isDisabled)), Hu = I(() => e.multiple ? e.collapseTags ? s.selected.slice(0, e.maxCollapseTags) : s.selected : []), ju = I(() => e.multiple ? e.collapseTags ? s.selected.slice(e.maxCollapseTags) : [] : []), Ka = (S) => {
    if (!D.value) {
      D.value = !0;
      return;
    }
  ...
  }), Gu = I(() => ({ maxWidth: `${s.selectionWidth}px` })), Yu = (S) => {
    t("popup-scroll", S);
  };
  return Bt(i, de), Bt(g, L), Bt(N, L), Bt(m, P), Bt(T, J), De(() => {
    A();
  }), {
    inputId: Q,
    contentId: r,
...
const Sh = Object.prototype.hasOwnProperty;
function mt(e, t) {
  return Sh.call(e, t);
}
...
function Yh(e = {}) {
  ...
  function u(c, h) {
    ...
    return N.value = h.replace(Kh, Gh), c.nextToken(), a(N, c.currentOffset(), c.currentPosition()), N;
  }
  function f(c) {
...
function nb(e = {}) {
  const t = e.locale, n = eb(e), r = re(e.pluralRules) && U(t) && ve(e.pluralRules[t]) ? e.pluralRules[t] : Nl, o = re(e.pluralRules) && U(t) && ve(e.pluralRules[t]) ? Nl : void 0, a = (c) => c[r(n, c.length, o)], s = e.list || [], l = (c) => s[c], i = e.named || ie();
...
function Ll(e, ...t) {
  ...
  let j = r ? r(X, i) : X;
  if (d && U(j) && (j = Nh(j)), process.env.NODE_ENV !== "production" || __INTLIFY_PROD_DEVTOOLS__) {
    const Q = {
      timestamp: Date.now(),
...
function Wa(e = {}) {
  ...
  const n = bb(t), r = Tb(n), o = Su(t), a = Eb(e, o);
  if (a === "global")
    return pb(r, e, o), r;
  if (a === "parent") {
...
const RE = "https://raw.githubusercontent.com/GigaPuddings/snippets-code-t/codex/plugin-system-refactor/docs/plugin-marketplace/marketplace.json";
async function DE() {
...
async function kE(e, t = !1) {
  return await Se("install_local_plugin_package", {
    sourcePath: e,
    overwrite: t
  });
}
async function FE(e, t = !1, n, r) {
...
const Sb = "resources/transformers/transformers.min.js", Lb = ["translation-offline-runtime", "translation"], Ib = "https://huggingface.co/", Ab = "{model}/resolve/{revision}/", Pb = "/__snippets_code_disabled_transformers_local_models__/";
let tr = null;
const Rb = (e) => {
  ...
  var n, r;
  e.useBrowserCache = !0, e.allowRemoteModels = !0, e.remoteHost = Ib, e.remotePathTemplate = Ab, e.allowLocalModels = !1, e.localModelPath = Pb, t && (e.backends ?? (e.backends = {}), (n = e.backends).onnx ?? (n.onnx = {}), (r = e.backends.onnx).wasm ?? (r.wasm = {}), e.backends.onnx.wasm.wasmPaths = Rb(t), e.backends.onnx.wasm.numThreads = 1);
};
async function Db() {
  return tr || (tr = (async () => {
    for (const e of Lb) {
      const t = await Nb(e, Sb);
      if (!t) continue;
...
const Mb = "Xenova/opus-mt-en-zh", kb = [
...
async function Pu() {
  return zt || Mn || (sr = !0, be.info("[离线翻译] 正在加载翻译模型..."), Mn = (async () => {
    try {
      const { pipeline: e, env: t } = await Db();
      Au(t);
      let n = "";
      const r = e("translation", Mb, {
        dtype: "q8",
        device: "wasm",
        revision: "main",
        local_files_only: !1,
...
const WE = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  canUseOfflineTranslation: Gb,
  cancelOfflineTranslation: Bb,
  clearModelCache: Xb,
  disposeOfflineTranslator: Yb,
  getModelCacheInfo: Ru,
  getModelFiles: Ub,
  isModelCached: Kb,
  isOfflineTranslatorInitializing: zb,
  isOfflineTranslatorReady: jb,
  isTranslationInProgress: Wb,
  setProgressCallback: $b,
  translateOffline: Vb,
  warmupOfflineTranslator: Hb
}, Symbol.toStringTag, { value: "Module" })), HE = (e, t) => {
  const n = e.__vccOpts || e;
  for (const [r, o] of t)
    n[r] = o;
  return n;
