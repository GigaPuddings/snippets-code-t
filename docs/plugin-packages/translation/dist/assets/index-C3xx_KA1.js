...
import { I as kt, c as z, d as ne, r as ht, k as dt, ao as we, w as Zt, l as Vt, a as K, o as Z, e as N, q as D, F as Tt, h as Rt, n as St, b as ie, y as me, u as xt, B as wt, s as Yt, f as ye, p as pe, a1 as ve, ah as ke, ag as qt } from "./runtime-entry-yPFnsQUl.js";
import { W as se } from "./window-93h2EbbU.js";
import { l as W, f as j, a8 as mt, e as Se, k as oe, h as Nt } from "./_plugin-vue_export-helper-BykmhDAa.js";
import { a as zt, c as Wt, P as be } from "./text-B6h9g8j8.js";
import { W as Me } from "./Write-Rejnb4-Y.js";
import { T as Ce } from "./TextRecognition-DvoStU30.js";
import { C as Te } from "./Check-BdkrY0_K.js";
import { C as Re } from "./Close--OyDGTLy.js";
const ze = kt("arrow-left-up", !0, function(o) {
  return z("svg", {
    width: o.size,
    height: o.size,
    viewBox: "0 0 48 48",
...
}), Ae = kt("delete-four", !1, function(o) {
  return z("svg", {
    width: o.size,
    height: o.size,
    viewBox: "0 0 48 48",
...
}), Ie = kt("rectangle-one", !1, function(o) {
  return z("svg", {
    width: o.size,
    height: o.size,
    viewBox: "0 0 48 48",
...
class bt {
  ...
  static async loadOCR() {
    ...
    const e = import("./ocr-BiM3nVnq.js").then((n) => (this.loadedModules.set(t, n), this.loadingPromises.delete(t), n));
  ...
  static async loadOfflineTranslator() {
    ...
    if (this.loadingPromises.has(t))
      return this.loadingPromises.get(t);
    const e = import("./_plugin-vue_export-helper-BykmhDAa.js").then((n) => n.bz).then((n) => (this.loadedModules.set(t, n), this.loadingPromises.delete(t), n));
    return this.loadingPromises.set(t, e), e;
  }
  /**
   * 预加载模块（在空闲时）
...
const Fe = /[.!?。！？；;：:][)"'”’】）\]]*$/, Jt = /[\u3040-\u30ff\u3400-\u4dbf\u4e00-\u9fff\uac00-\ud7af]/, _t = /[A-Za-z0-9]/, Ue = /^\s*(?:[-*+•·]\s+|\d+[.)、）]\s*|[a-zA-Z][.)]\s+)/;
function Xe(o) {
...
function ae(o, t) {
  ...
  for (const s of e) {
    ...
    a && Math.abs(s.y - a.y) < i && !hn(a.blocks, s, t) ? (a.blocks.push(s), a.y = Pt(a.blocks.map((r) => r.y))) : n.push({ y: s.y, blocks: [s] });
  }
  return n.map((s) => Je(s.blocks, t));
}
function Je(o, t) {
  const e = [...o].sort((r, l) => r.x - l.x), n = xn(e), i = e.reduce((r, l, c) => {
    const d = l.text.trim();
    return c === 0 ? d : en(r, d);
...
function re(o, t) {
  ...
  return i === "-" && _t.test(a) && _t.test(s) ? `${e.slice(0, -1)}${n}` : mn(s) || yn(i) ? `${e}${n}` : Jt.test(i) || Jt.test(s) || ee(i) || ee(s) ? `${e}${n}` : _t.test(i) && _t.test(s) ? `${e} ${n}` : `${e} ${n}`.replace(/\s+/g, " ");
}
function jt(o) {
  return Fe.test(o.trim());
}
function le(o) {
  return Ue.test(o);
}
...
class pn {
  constructor(t, e, n, i) {
    ...
    this.canvas = t, this.onStateChange = e, this.onTextInputRequest = n, this.onColorPicked = i, this.coordinateSystem = new Ee(t), this.drawingEngine = new _e(t, this.coordinateSystem), this.eventHandler = new Oe(t, this.coordinateSystem), this.bindMouseEvents(), this.initCanvas(), Promise.all([
  ...
  async performOcrTranslation() {
    if (!(!this.selectionRect || !this.backgroundImage))
      try {
        ...
        const C = B.blocks, H = performance.now(), P = Xe(C);
...
const vn = { class: "toolbar-panel first-panel" }, kn = { class: "tool-section" }, Sn = ["onClick", "title"], bn = { class: "action-section" }, Mn = ["disabled", "title"], Cn = ["disabled", "title"], Tn = ["title"], Rn = ["title"], zn = ["title"], An = {
  key: 0,
  ...
  setup(o, { expose: t, emit: e }) {
    const n = ht(!1), i = ht(null), { t: s } = Se(), a = o, r = e, l = dt(() => [
      { type: u.Select, icon: We, title: s("screenshot.select") },
      { type: u.Rectangle, icon: Ie, title: s("screenshot.rectangle") },
      { type: u.Arrow, icon: ze, title: s("screenshot.arrow") },
      { type: u.Pen, icon: Me, title: s("screenshot.pen") },
      { type: u.Mosaic, icon: Le, title: s("screenshot.mosaic") },
      { type: u.Text, icon: De, title: s("screenshot.text") },
      { type: u.ColorPicker, icon: Gt, title: s("screenshot.colorPicker") },
      { type: u.Ocr, icon: Ce, title: s("screenshot.ocr") },
      { type: u.Translate, icon: we, title: s("screenshot.translate") },
      { type: u.Pin, icon: be, title: s("screenshot.pin") }
    ]), c = dt(() => [
  ...
  setup(o) {
    ...
    return ye(async () => {
      if (t.value) {
        i.value = new se("screenshot"), await i.value.emit("screenshot_ready"), s = new pn(
          t.value,
          $,
          ct,
          Et
...
}), fi = /* @__PURE__ */ oe(si, [["__scopeId", "data-v-77c8952b"]]);
export {
  fi as default
};
