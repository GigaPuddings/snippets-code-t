...
import { I as Mt, c as C, d as ne, r as ft, k as rt, ao as fe, w as xe, a as Z, o as X, e as I, q as P, F as zt, h as Dt, n as Tt, b as ie, y as we, u as ht, B as xt, s as _t, f as me, p as ye, a1 as pe, ah as ve, ag as Gt, l as ke } from "./runtime-entry-CxfepRbR.js";
import { W as se } from "./window-Db5Kk4wM.js";
import { l as z, f as j, a8 as pt, e as Se, k as oe, h as Ft } from "./_plugin-vue_export-helper-Kpx6kpKo.js";
import { a as Wt, c as Ht, P as be } from "./text-DzsoDk8o.js";
import { W as Me } from "./Write-gL2iiYUh.js";
import { T as Ce } from "./TextRecognition-DtnFUVpO.js";
import { C as Te } from "./Check-A9nkJl8Z.js";
...
class Rt {
  ...
  static async loadOCR() {
    ...
    const e = import("./ocr-CMwyfhOd.js").then((n) => (this.loadedModules.set(t, n), this.loadingPromises.delete(t), n));
  ...
  static async loadOfflineTranslator() {
    ...
    if (this.loadingPromises.has(t))
      return this.loadingPromises.get(t);
    const e = import("./_plugin-vue_export-helper-Kpx6kpKo.js").then((n) => n.bz).then((n) => (this.loadedModules.set(t, n), this.loadingPromises.delete(t), n));
    return this.loadingPromises.set(t, e), e;
  }
  /**
   * 预加载模块（在空闲时）
