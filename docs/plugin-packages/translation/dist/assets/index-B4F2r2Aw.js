import { f as v, e as z, n as y, E as S, o as f, q as F } from "./_plugin-vue_export-helper-BxX7cX_q.js";
import { d as E, r as h, k as V, f as C, a as N, o as T, e as c, q as e, s as n, c as m, u as i, v as I } from "./runtime-entry-C62Reu10.js";
import { E as P } from "./index-BLWmBi1y.js";
async function U() {
  try {
  ...
  setup(d) {
    ...
    async function g() {
      if (!r.value) {
        r.value = !0;
        try {
          await k(s.value), f.msg(o("settings.attachment.configSaved"));
        } catch (t) {
...
}), ie = /* @__PURE__ */ F(te, [["__scopeId", "data-v-52dba400"]]);
export {
  ie as default
};
