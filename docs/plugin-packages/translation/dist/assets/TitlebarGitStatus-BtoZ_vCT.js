import { k as w } from "./_plugin-vue_export-helper-CKv_N83a.js";
import { E } from "./dropdown-item-B8eljqB9.js";
import { I as L, c as n, C as V, d as N, k as j, f as W, p as D, a as i, b as c, e as a, o, u as e, s as r, n as z, v as B, q as G } from "./runtime-entry-DtonpMUQ.js";
import { u as O, f as I, i as M, h as x } from "./useGitStatus-D6elna5O.js";
import { L as Z } from "./Loading-pBEcsFTC.js";
...
const H = ["title"], K = {
  ...
  setup(t) {
    const p = q(), {
      ...
      stateDescription: b,
      gitSettings: y
    } = O(), h = j(() => !!y.value?.enabled && s.value !== "error"), k = () => {
    ...
    return W(async () => {
      ...
      const S = E;
      return h.value && m.variant === "inline" ? (o(), i("div", {
        key: 0,
