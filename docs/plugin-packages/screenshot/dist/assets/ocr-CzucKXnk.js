import { o as a, i as s, f as l, l as u } from "./_plugin-vue_export-helper-BYXe8loQ.js";
async function f(n) {
...
`), i = {
      ...
      full_text: o,
      text: o,
      language: typeof e.language == "string" && e.language || l(o),
    ...
    throw u.error("[OCR] RapidOCR recognizeFromCanvas failed", e), a.log("[RapidOCR] recognizeFromCanvas failed", {
      durationMs: Date.now() - r,
