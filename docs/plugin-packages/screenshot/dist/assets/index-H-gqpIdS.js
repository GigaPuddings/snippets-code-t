...
import { c as b, d as ne, r as ft, a as rt, w as fe, b as Z, e as I, f as P, F as zt, g as Dt, u as ht, n as xt, h as Tt, o as X, i as ie, j as xe, t as Ht, k as we, l as me, m as ye, v as pe, p as Gt, q as ve } from "./runtime-entry-QeDq3THj.js";
import { l as z, i as j, W as se, o as pt, d as Lt, c as _t, I as Mt, u as ke, T as Se, a as Me, P as be, C as Ce, b as Te, _ as oe, e as Ft } from "./_plugin-vue_export-helper-BTXnX6zC.js";
function ot(s, t) {
...
function Re(s, t) {
  return {
    x: Math.max(t.x, Math.min(s.x, t.x + t.width)),
    y: Math.max(t.y, Math.min(s.y, t.y + t.height))
  };
}
function kt(s) {
  return s != null && typeof s.x == "number" && typeof s.y == "number" && !isNaN(s.x) && !isNaN(s.y) && isFinite(s.x) && isFinite(s.y);
}
function Wt(s) {
  return s != null && typeof s.x == "number" && typeof s.y == "number" && typeof s.width == "number" && typeof s.height == "number" && !isNaN(s.x) && !isNaN(s.y) && !isNaN(s.width) && !isNaN(s.height) && isFinite(s.x) && isFinite(s.y) && isFinite(s.width) && isFinite(s.height) && s.width > 0 && s.height > 0;
}
class Ae {
  constructor(t, e) {
    m(this, "canvas");
  ...
  drawMask(t) {
    ...
    this.ctx.save();
    const e = this.canvas.width / (window.devicePixelRatio || 1), n = this.canvas.height / (window.devicePixelRatio || 1), i = Math.round(t.x), o = Math.round(t.y), a = Math.round(t.width), r = Math.round(t.height);
    this.ctx.fillStyle = "rgba(0, 0, 0, 0.5)", this.ctx.beginPath(), this.ctx.rect(0, 0, e, n), this.ctx.moveTo(i, o), this.ctx.lineTo(i, o + r), this.ctx.lineTo(i + a, o + r), this.ctx.lineTo(i + a, o), this.ctx.closePath(), this.ctx.fill("evenodd"), this.ctx.restore();
  }
  // 绘制选择框
  drawSelectionBox(t, e = !0) {
    const { x: n, y: i, width: o, height: a } = t;
    this.ctx.strokeStyle = "#3b82f6", this.ctx.lineWidth = 2, this.ctx.setLineDash([6, 6]), this.ctx.strokeRect(n, i, o, a), e && (this.drawGuides(t), this.drawHandles(t));
  }
  // 绘制辅助线
  drawGuides(t) {
    ...
    const a = i / 3, r = o / 3;
    this.ctx.beginPath(), this.ctx.moveTo(e + a, n), this.ctx.lineTo(e + a, n + o), this.ctx.moveTo(e + a * 2, n), this.ctx.lineTo(e + a * 2, n + o), this.ctx.moveTo(e, n + r), this.ctx.lineTo(e + i, n + r), this.ctx.moveTo(e, n + r * 2), this.ctx.lineTo(e + i, n + r * 2), this.ctx.stroke();
  }
  // 绘制控制点
  drawHandles(t) {
    const { x: e, y: n, width: i, height: o } = t, a = Xt(t);
  ...
  drawAnnotations(t, e) {
    ...
    t.forEach((i) => {
      const o = i.getData();
      o.hovered && i.drawHover(n), i.draw(n), o.selected && (i.drawSelection(n), (o.type === "rectangle" || o.type === "arrow") && this.drawAnnotationHandles(i));
    });
  }
  // 绘制当前正在创建的标注
  ...
  drawAnnotationHandles(t) {
    ...
    if (e.type !== "mosaic" && e.type !== "text" && (e.type === "rectangle" || e.type === "arrow") && e.points.length >= 2) {
      const n = e.points[0], i = e.points[e.points.length - 1], o = 4;
      this.ctx.save(), this.ctx.setLineDash([]), this.ctx.fillStyle = "#ffffff", this.ctx.strokeStyle = "#3b82f6", this.ctx.lineWidth = 2, this.ctx.beginPath(), this.ctx.arc(n.x, n.y, o, 0, Math.PI * 2), this.ctx.fill(), this.ctx.stroke(), this.ctx.beginPath(), this.ctx.arc(i.x, i.y, o, 0, Math.PI * 2), this.ctx.fill(), this.ctx.stroke(), this.ctx.restore();
    }
  }
  // 绘制取色器
  drawColorPicker(t, e) {
    if (!t.isActive || !t.isVisible) return;
    const { mousePosition: n, colorInfo: i, showFormat: o, previewImage: a, zoomFactor: r, isCopied: l } = t, c = 150, g = 190, x = 20;
    let d = n.x + x, y = n.y + x;
    d + c > e.x + e.width && (d = n.x - c - x), y + g > e.y + e.height && (y = n.y - g - x), d < e.x && (d = e.x + x), y < e.y && (y = e.y + x), this.ctx.save(), this.ctx.fillStyle = "rgba(255, 255, 255, 0.9)", this.ctx.strokeStyle = "rgba(0, 0, 0, 0.1)", this.ctx.lineWidth = 1, this.ctx.shadowColor = "rgba(0, 0, 0, 0.2)", this.ctx.shadowBlur = 10, this.ctx.beginPath(), this.ctx.roundRect(d, y, c, g, 8), this.ctx.fill(), this.ctx.stroke(), this.ctx.shadowColor = "transparent";
    const p = 100, v = d + (c - p) / 2, R = y + 15;
    this.ctx.strokeStyle = "#ccc", this.ctx.lineWidth = 1, this.ctx.strokeRect(v, R, p, p);
    const E = a ? a.width : r, _ = p / E;
    ...
    const M = Math.floor(E / 2), D = v + M * _, L = R + M * _;
    ...
    let W = R + p + 25;
    if (i) {
      this.ctx.fillStyle = i.hex, this.ctx.fillRect(d + 15, W - 13, 16, 16), this.ctx.strokeStyle = "#ccc", this.ctx.strokeRect(d + 15, W - 13, 16, 16), this.ctx.fillStyle = "#333";
      const A = o === "hex" ? i.hex : `${i.rgb.r}, ${i.rgb.g}, ${i.rgb.b}`;
      this.ctx.fillText(A, d + 40, W), W += 20;
    }
    this.ctx.fillStyle = "#666", this.ctx.font = "12px Arial", this.ctx.fillText(`X: ${Math.round(n.x)}, Y: ${Math.round(n.y)}`, d + 15, W), W += 20, this.ctx.font = "12px Arial";
    const F = l ? "已复制!" : "Q:复制 Shift:切换";
    this.ctx.fillStyle = l ? "#00A000" : "#888", this.ctx.fillText(F, d + 15, W), this.ctx.restore();
  }
}
class Pe {
  // 物理尺寸
  ...
  logicalToRelative(t, e) {
    return !kt(t) || !Wt(e) ? (console.warn("Invalid point or bounds in logicalToRelative"), { x: 0, y: 0 }) : {
      x: t.x - e.x,
      y: t.y - e.y
    };
  }
  ...
  relativeToLogical(t, e) {
    return !kt(t) || !Wt(e) ? (console.warn("Invalid point or bounds in relativeToLogical"), { x: 0, y: 0 }) : {
      x: t.x + e.x,
      y: t.y + e.y
    };
  }
  ...
  clampRectToCanvas(t) {
    ...
    const e = Math.max(0, t.x), n = Math.max(0, t.y), i = Math.min(this.canvasSize.width - e, t.width), o = Math.min(this.canvasSize.height - n, t.height);
    return { x: e, y: n, width: i, height: o };
  }
  // 获取画布尺寸
  getCanvasSize() {
  ...
  isPointNearLine(t, e, n, i = 8) {
    if (!kt(t) || !kt(e) || !kt(n))
      return !1;
    const o = t.x - e.x, a = t.y - e.y, r = n.x - e.x, l = n.y - e.y, c = o * r + a * l, g = r * r + l * l;
    if (g === 0)
      return ot(t, e) <= i;
    const x = c / g;
    let d;
...
var w = /* @__PURE__ */ ((s) => (s.None = "none", s.Drawing = "drawing", s.Moving = "moving", s.ResizingNW = "resizing-nw", s.ResizingNE = "resizing-ne", s.ResizingSW = "resizing-sw", s.ResizingSE = "resizing-se", s.ResizingN = "resizing-n", s.ResizingS = "resizing-s", s.ResizingW = "resizing-w", s.ResizingE = "resizing-e", s.DrawingRect = "drawing-rect", s.DrawingArrow = "drawing-arrow", s.DrawingPen = "drawing-pen", s.EditingAnnotation = "editing-annotation", s.MovingAnnotation = "moving-annotation", s.ResizingAnnotationNW = "resizing-annotation-nw", s.ResizingAnnotationSE = "resizing-annotation-se", s.DrawingText = "drawing-text", s.DrawingMosaic = "drawing-mosaic", s.ColorPicking = "color-picking", s.Pinning = "pinning", s))(w || {}), u = /* @__PURE__ */ ((s) => (s.Select = "select", s.Rectangle = "rectangle", s.Arrow = "arrow", s.Pen = "pen", s.Mosaic = "mosaic", s.Text = "text", s.ColorPicker = "color-picker", s.Ocr = "ocr", s.Pin = "pin", s.Translate = "translate", s))(u || {});
class ze {
  constructor(t, e) {
  ...
  getSelectionOperationType(t, e, n) {
    const { x: i, y: o, width: a, height: r } = e, l = 12;
    if (n)
      return w.None;
    const c = Xt(e);
    return this.isInHandle(t, { x: i, y: o }, l) ? w.ResizingNW : this.isInHandle(t, { x: i + a, y: o }, l) ? w.ResizingNE : this.isInHandle(t, { x: i, y: o + r }, l) ? w.ResizingSW : this.isInHandle(t, { x: i + a, y: o + r }, l) ? w.ResizingSE : this.isInHandle(t, { x: c.x, y: o }, l) ? w.ResizingN : this.isInHandle(t, { x: c.x, y: o + r }, l) ? w.ResizingS : this.isInHandle(t, { x: i, y: c.y }, l) ? w.ResizingW : this.isInHandle(t, { x: i + a, y: c.y }, l) ? w.ResizingE : this.coordinateSystem.isPointInRect(t, e) ? w.Moving : w.Drawing;
  }
  // 检查是否在控制点范围内
  isInHandle(t, e, n) {
  ...
  getAnnotationControlPointOperation(t, e) {
    ...
    if ((n.type === u.Rectangle || n.type === u.Arrow) && n.points.length >= 2) {
      const i = n.points[0], o = n.points[n.points.length - 1], a = 8, r = 6, l = ot(t, i), c = ot(t, o);
      if (l <= a + r)
...
class De extends Et {
  ...
  draw(t) {
    ...
    const { ctx: e } = t, n = this.data.points[0], i = this.data.points[this.data.points.length - 1], o = i.x - n.x, a = i.y - n.y;
    e.save(), e.strokeStyle = this.data.style.color, e.lineWidth = this.data.style.lineWidth, e.lineCap = "round", e.lineJoin = "round", e.setLineDash([]), e.strokeRect(n.x, n.y, o, a), e.restore();
  }
  drawToScreenshot(t) {
    if (this.data.points.length < 2) return;
    const { ctx: e, scale: n, offset: i } = t, o = this.data.points[0], a = this.data.points[this.data.points.length - 1], r = {
      x: o.x * n - i.x,
      y: o.y * n - i.y
    }, l = (a.x - o.x) * n, c = (a.y - o.y) * n;
  ...
  hitTest(t, e = 8) {
    ...
    const n = this.data.points[0], i = this.data.points[this.data.points.length - 1], o = Math.min(n.x, i.x), a = Math.max(n.x, i.x), r = Math.min(n.y, i.y), l = Math.max(n.y, i.y);
    return t.x >= o - e && t.x <= a + e && t.y >= r - e && t.y <= l + e;
  }
  getBounds() {
    if (this.data.points.length < 2) return null;
    const t = this.data.points[0], e = this.data.points[this.data.points.length - 1], n = Math.min(t.x, e.x), i = Math.max(t.x, e.x), o = Math.min(t.y, e.y), a = Math.max(t.y, e.y);
    return {
      x: n,
      y: o,
      width: i - n,
  ...
  drawHover(t) {
    if (this.data.points.length < 2) return;
    const { ctx: e } = t, n = this.data.points[0], i = this.data.points[this.data.points.length - 1], o = i.x - n.x, a = i.y - n.y;
    e.save(), e.strokeStyle = "#3b82f6", e.lineWidth = 2, e.setLineDash([4, 4]), e.strokeRect(n.x, n.y, o, a), e.restore();
  }
  // 获取控制点位置检测
...
class Le extends Et {
  ...
  drawArrow(t, e, n) {
    const i = this.data.points[0], o = this.data.points[this.data.points.length - 1], a = {
      x: i.x * e - n.x,
      y: i.y * e - n.y
    }, r = {
      x: o.x * e - n.x,
    ...
    const l = Math.atan2(o.y - i.y, o.x - i.x), c = 15 * e, g = Math.PI / 6;
...
class We extends Et {
  ...
  addPoint(t) {
    if (this.data.points.length > 0) {
      ...
      if (n > 5) {
        ...
        for (let o = 1; o < i; o++) {
          const a = o / i, r = e.x + (t.x - e.x) * a, l = e.y + (t.y - e.y) * a;
  ...
  drawPath(t, e, n) {
    ...
    const i = this.data.points[0], o = i.x * e - n.x, a = i.y * e - n.y;
    t.moveTo(o, a);
    for (let r = 1; r < this.data.points.length; r++) {
      const l = this.data.points[r], c = l.x * e - n.x, g = l.y * e - n.y;
      t.lineTo(c, g);
    }
    t.stroke(), t.restore();
  }
  hitTest(t, e = 8) {
    ...
    for (let n = 0; n < this.data.points.length - 1; n++) {
      const i = this.data.points[n], o = this.data.points[n + 1];
      if (this.isPointNearLine(t, i, o, e))
        return !0;
    }
    return !1;
  }
...
class Ie extends Et {
  ...
  drawToScreenshot(t) {
    if (!this.data.text || this.data.points.length === 0) return;
    const { ctx: e, scale: n, offset: i, bounds: o } = t;
    this.drawText(e, n, i, o);
  }
  drawText(t, e, n, i) {
  ...
  hitTest(t, e = 8) {
    ...
    const l = a.measureText(this.data.text).width, c = n.x + 4, g = n.y - 8;
    return t.x >= c - e && t.x <= c + l + e && t.y >= g - e && t.y <= g + i + e;
  }
  getBounds() {
  ...
  drawSelection(t) {
    if (!this.data.text || this.data.points.length === 0) return;
    const { ctx: e, scale: n, offset: i } = t, o = this.data.points[0], a = (this.data.fontSize || 16) * n, r = (o.x + 4) * n - i.x, l = (o.y - 8) * n - i.y;
...
const St = class St extends Et {
  ...
  renderRealMosaic(t, e, n, i) {
    ...
    const o = St.helperCanvas, a = St.helperCtx, r = e || 1, l = this.data.mosaicSize || 5, c = Math.max(Math.round(l * r), 2), g = l * 3, x = this.getBounds();
    if (!x) return;
    const d = g, y = Math.floor(x.x - d), p = Math.floor(x.y - d), v = Math.ceil(x.width + d * 2), R = Math.ceil(x.height + d * 2);
    if (v <= 0 || R <= 0) return;
    const E = Math.floor(y * r - n.x), _ = Math.floor(p * r - n.y), M = Math.ceil(v * r), D = Math.ceil(R * r), L = t.canvas.width, W = t.canvas.height, F = Math.max(0, E), A = Math.max(0, _), O = Math.min(M, L - F), H = Math.min(D, W - A);
    if (O <= 0 || H <= 0) return;
    let B;
    try {
      t.save(), t.setTransform(1, 0, 0, 1, 0, 0), B = t.getImageData(F, A, O, H), t.restore();
    } catch {
      return;
    }
    const Y = B.data, N = F % c, it = A % c;
    for (let U = -it; U < H; U += c)
      for (let C = -N; C < O; C += c) {
        const k = Math.max(0, C), $ = Math.max(0, U), S = Math.min(O, C + c), V = Math.min(H, U + c);
        if (k >= S || $ >= V) continue;
    ...
    o.width = O, o.height = H, a.putImageData(B, 0, 0), a.globalCompositeOperation = "destination-in", a.lineCap = "round", a.lineJoin = "round", a.lineWidth = g * r, a.fillStyle = "#000000", a.strokeStyle = "#000000", this.drawPathPhysical(a, r, n, F, A), t.save(), t.setTransform(1, 0, 0, 1, 0, 0), i && (t.beginPath(), t.rect(
      i.x * r - n.x,
      i.y * r - n.y,
      i.width * r,
      i.height * r
    ), t.clip()), t.drawImage(o, F, A), t.restore();
  }
  // 在物理坐标系中绘制路径
  drawPathPhysical(t, e, n, i, o) {
    if (this.data.points.length < 1) return;
    t.beginPath();
    const a = (l) => l.x * e - n.x - i, r = (l) => l.y * e - n.y - o;
  ...
  hitTest(t, e = 8) {
    ...
    for (let n = 0; n < this.data.points.length - 1; n++) {
      const i = this.data.points[n], o = this.data.points[n + 1];
      if (this.isPointNearLine(t, i, o, (this.data.mosaicSize || 5) / 2 + e))
        return !0;
    }
    return !1;
  }
...
class Ot {
  ...
  static fromData(t) {
    ...
    const o = n[0], a = this.createAnnotation(e, o, i, {
      text: t.text,
      fontSize: t.fontSize,
...
const At = class At {
  ...
  acquire(t, e) {
    ...
    return o && o.clearRect(0, 0, t, e), this.inUse.add(i), i;
  }
  /**
   * 释放 canvas 对象回池中
...
class Rt {
  ...
  static async loadOCR() {
    ...
    const e = import("./ocr-C_XImBaF.js").then((n) => (this.loadedModules.set(t, n), this.loadingPromises.delete(t), n));
  ...
  static async loadOfflineTranslator() {
    ...
    if (this.loadingPromises.has(t))
      return this.loadingPromises.get(t);
    const e = import("./offlineTranslator-DZDuuYCu.js").then((n) => (this.loadedModules.set(t, n), this.loadingPromises.delete(t), n));
    return this.loadingPromises.set(t, e), e;
  }
  /**
   * 预加载模块（在空闲时）
...
const _e = /[.!?。！？；;：:][)"'”’】）\]]*$/, Kt = /[\u3040-\u30ff\u3400-\u4dbf\u4e00-\u9fff\uac00-\ud7af]/, $t = /[A-Za-z0-9]/, He = /^\s*(?:[-*+•·]\s+|\d+[.)、）]\s*|[a-zA-Z][.)]\s+)/;
function Be(s) {
  const t = rn(s), e = Ee(s, t);
  if (e.length === 0)
    return [];
  const n = ae(e, t), i = [];
  for (const o of n) {
    const a = i[i.length - 1], r = a ? Ye(a, o, t) : !1;
    if (!a || !r) {
      i.push(Ue(o));
      continue;
    }
    a.text = je(a.text, o.text), a.blocks = [...a.blocks, ...o.blocks], a.bbox = he(a.bbox, o.bbox), a.fontSize = Qt(
...
function Oe(s, t) {
  ...
  if (!/^[cC]$/.test(e))
    return !1;
  const n = t * 1.25;
  return s.width <= n && s.height <= n;
}
function $e(s, t, e) {
  return /^xC$/i.test(s) && t.width <= e * 2.4 ? "X" : s;
}
function Ne(s) {
  return /^(?:en|zh|ja|ko|de|fr|es|ru|pt|it|nl)[A-Z]{2,4}$/.test(s.trim());
}
function Ve(s) {
...
function ae(s, t) {
  ...
  for (const o of e) {
    ...
    a && Math.abs(o.y - a.y) < i && !tn(a.blocks, o, t) ? (a.blocks.push(o), a.y = It(a.blocks.map((r) => r.y))) : n.push({ y: o.y, blocks: [o] });
  }
  return n.map((o) => Fe(o.blocks, t));
}
function Fe(s, t) {
  const e = [...s].sort((r, l) => r.x - l.x), n = an(e), i = e.reduce((r, l, c) => {
    const g = l.text.trim();
    return c === 0 ? g : Xe(r, g);
  }, ""), o = It(e.map((r) => Bt(r.fontSize, t))), a = It(e.map((r) => de(r)));
  return {
    text: i,
    blocks: e,
    bbox: n,
...
function Ye(s, t, e) {
  const n = ae(s.blocks, e), i = n[n.length - 1];
  if (!i || jt(i.text) || le(t.text) || t.isCodeLike || i.isCodeLike || t.hasTableColumns || i.hasTableColumns) return !1;
  const o = t.bbox.y - (i.bbox.y + i.bbox.height);
  if (o < -e * 0.25 || o >= e * 1.8 || Ze(n, o, e) || Ge(i, t, o, e) || qe(i, t, o, e) || Ke(i, t, o, e) || Je(i, t, o, e))
    return !1;
...
function Ue(s) {
  return {
    ...
    blocks: [...s.blocks],
    bbox: { ...s.bbox },
    isCodeBlock: s.isCodeLike || s.hasTableColumns,
    isStructuredBlock: s.hasTableColumns,
    fontSize: s.fontSize,
    lineHeight: s.lineHeight,
    angle: It(s.blocks.map((t) => t.angle || 0))
  };
}
function Xe(s, t) {
  return re(s, t);
...
function re(s, t) {
  const e = s.trimEnd(), n = t.trimStart();
  if (!e) return n;
  if (!n) return e;
  const i = e.charAt(e.length - 1), o = n.charAt(0), a = e.charAt(e.length - 2);
  return i === "-" && $t.test(a) && $t.test(o) ? `${e.slice(0, -1)}${n}` : ln(o) || cn(i) ? `${e}${n}` : Kt.test(i) || Kt.test(o) || te(i) || te(o) ? `${e}${n}` : $t.test(i) && $t.test(o) ? `${e} ${n}` : `${e} ${n}`.replace(/\s+/g, " ");
}
function jt(s) {
  return _e.test(s.trim());
}
function le(s) {
  return He.test(s);
}
function Ze(s, t, e) {
  ...
  for (let a = 1; a < s.length; a++) {
    const r = s[a - 1], c = s[a].bbox.y - (r.bbox.y + r.bbox.height);
    c > 0 && n.push(c);
  }
  const i = n.length > 0 ? It(n) : 0, o = Math.max(i * 2.2, e * 1.15);
  return t > o;
}
function Ge(s, t, e, n) {
  const i = s.text.trim();
  if (!i || jt(i) || le(i) || s.isCodeLike || i.endsWith("-"))
    return !1;
  const o = i.split(/\s+/).filter(Boolean).length, a = s.bbox.width < t.bbox.width * 0.72, r = /^[A-Z][A-Za-z0-9\s:,'&()[\]/-]+$/.test(i) && o <= 8 && a, l = /[\u3400-\u4dbf\u4e00-\u9fff]/.test(i) && i.length <= 12 && a, c = r || l;
  return s.fontSize >= t.fontSize * 1.18 && c ? !0 : e > n * 0.7 && c;
}
function qe(s, t, e, n) {
  if (e <= 0)
    return !1;
  const i = Math.max(s.fontSize, t.fontSize), o = Math.max(Math.min(s.fontSize, t.fontSize), 1), a = i / o, r = e / Math.max(o, n * 0.6, 1);
  if (a >= 1.45 && r >= 0.65)
    return !0;
  const l = s.fontSize >= n * 1.08 && s.bbox.width >= t.bbox.width * 0.82, c = t.fontSize <= s.fontSize * 0.78 && e >= Math.max(t.lineHeight * 0.75, n * 0.55);
  return l && c;
}
function Ke(s, t, e, n) {
  if (e < n * 0.45)
    return !1;
  const o = s.text.split(/\s+/).filter(Boolean).length <= 3 && s.bbox.width < t.bbox.width * 0.35, a = Math.abs(s.bbox.x - t.bbox.x) <= n * 0.6;
  return o && a;
}
function Je(s, t, e, n) {
  return e < n * 0.25 || !(Math.abs(s.bbox.x - t.bbox.x) <= n * 0.35) ? !1 : Jt(s.text) && Jt(t.text);
}
function Jt(s) {
  const t = s.trim();
...
function tn(s, t, e) {
  const n = [...s].sort((a, r) => a.x - r.x), i = n[n.length - 1], o = t.x - (i.x + i.width);
  return o > e * 0.9 && on(i.text) && ce(t.text) ? !1 : o > e * 3.2;
}
function en(s, t) {
  if (s.length < 2)
    return s.some((i) => nn(i.text));
  const e = [...s].sort((i, o) => i.x - o.x);
  let n = 0;
  for (let i = 1; i < e.length; i++) {
    const o = e[i - 1], a = e[i], r = e[i].x - (o.x + o.width);
    (r > t * 1.8 || r > t * 0.9 && sn(o.text) && ce(a.text)) && (n += 1);
  }
  return n >= 1;
}
function nn(s) {
...
function sn(s) {
  return /^[A-Za-z_][A-Za-z0-9_-]{1,24}$/.test(s.trim());
}
function on(s) {
  const t = s.trim();
...
function he(s, t) {
  const e = Math.min(s.x, t.x), n = Math.min(s.y, t.y), i = Math.max(s.x + s.width, t.x + t.width), o = Math.max(s.y + s.height, t.y + t.height);
  return {
    x: e,
    y: n,
    width: i - e,
...
function rn(s) {
  return Bt(It(s.map((t) => de(t))), 16);
}
function de(s) {
  return Bt(s.lineHeight, Bt(s.height, Bt(s.fontSize, 16) * 1.2));
}
function Qt(s, t, e, n) {
  const i = t + n;
  return i <= 0 ? e : (s * t + e * n) / i;
}
function Bt(s, t) {
  return Number.isFinite(s) && s > 0 ? s : t;
}
function It(s) {
  return s.length === 0 ? 0 : s.reduce((t, e) => t + e, 0) / s.length;
}
function ln(s) {
  return /^[,.;:!?，。！？；：、)\]}>"'”’]$/.test(s);
}
...
class hn {
  constructor(t, e, n, i) {
    ...
    this.canvas = t, this.onStateChange = e, this.onTextInputRequest = n, this.onColorPicked = i, this.coordinateSystem = new Pe(t), this.drawingEngine = new Ae(t, this.coordinateSystem), this.eventHandler = new ze(t, this.coordinateSystem), this.bindMouseEvents(), this.initCanvas(), Promise.all([
  ...
  initCanvas() {
    ...
    o && o.scale(i, i), this.drawPendingState(), this.coordinateSystem.updateCanvasRect(this.canvas);
  }
  // 绘制等待状态（背景图加载前的中间状态）
  drawPendingState() {
    ...
    for (; n < 5e3; )
      try {
        ...
        if (i && i.trim().length > 0)
          return;
        await new Promise((o) => setTimeout(o, 100)), n += 100;
      } catch (i) {
        const o = i?.toString() || "";
  ...
  detectNearbyWindow(t) {
    ...
    for (const n of this.allWindows) {
      ...
      const o = Math.abs(t.x - n.x), a = Math.abs(t.x - (n.x + n.width)), r = Math.abs(t.y - n.y), l = Math.abs(t.y - (n.y + n.height)), c = Math.min(o, a, r, l);
  ...
  updateSelectionRect(t, e) {
    ...
    const n = e.currentOperation, i = t.x - e.lastMousePos.x, o = t.y - e.lastMousePos.y;
    switch (n) {
      case w.Drawing:
        this.selectionRect.width = t.x - e.startPoint.x, this.selectionRect.height = t.y - e.startPoint.y;
        break;
      case w.Moving:
        this.selectionRect.x += i, this.selectionRect.y += o;
        break;
      case w.ResizingNW:
        this.selectionRect.x += i, this.selectionRect.y += o, this.selectionRect.width -= i, this.selectionRect.height -= o;
        break;
      case w.ResizingNE:
        this.selectionRect.y += o, this.selectionRect.width += i, this.selectionRect.height -= o;
        break;
      case w.ResizingSW:
        this.selectionRect.x += i, this.selectionRect.width -= i, this.selectionRect.height += o;
        break;
      case w.ResizingSE:
        this.selectionRect.width += i, this.selectionRect.height += o;
        break;
      case w.ResizingN:
  ...
  constrainAnnotationToBounds(t) {
    ...
    if (n.points.length >= 2)
      for (let r = 0; r < a.length; r++) {
        const l = a[r];
        l.x < i.x ? (a[r] = { ...l, x: i.x }, o = !0) : l.x > i.x + i.width && (a[r] = { ...l, x: i.x + i.width }, o = !0), l.y < i.y ? (a[r] = { ...l, y: i.y }, o = !0) : l.y > i.y + i.height && (a[r] = { ...l, y: i.y + i.height }, o = !0);
      }
    if (n.points.length > 2)
      for (let r = 0; r < a.length; r++) {
        const l = a[r];
        (l.x < i.x || l.x > i.x + i.width || l.y < i.y || l.y > i.y + i.height) && (a.splice(r, 1), r--, o = !0);
      }
  ...
  createCircleCursor(t, e = "#666") {
    const n = Math.max(t / 2, 2), i = n * 2 + 4, o = i / 2, a = `
      <svg width="${i}" height="${i}" xmlns="http://www.w3.org/2000/svg">
        <!-- 外圈：显示工具大小 -->
        <circle cx="${o}" cy="${o}" r="${n}" 
  ...
  drawTranslationOverlay() {
    ...
    if (!t) return;
    t.save();
    const { x: e, y: n, width: i, height: o } = this.selectionRect, a = 8;
    if (this.translationOverlay.isLoading) {
      const v = e + i / 2, R = n + o / 2;
      t.fillStyle = "rgba(0, 0, 0, 0.7)", t.fillRect(e, n, i, o), t.font = '16px "Microsoft YaHei", sans-serif', t.fillStyle = "#ffffff", t.textAlign = "center", t.textBaseline = "middle", t.fillText("正在识别翻译...", v, R), t.restore();
      return;
    }
    if (this.translationOverlay.errorMessage) {
      const v = e + i / 2, R = n + o / 2;
      t.fillStyle = "rgba(0, 0, 0, 0.8)", t.fillRect(e, n, i, o), t.font = '16px "Microsoft YaHei", sans-serif', t.fillStyle = "#ff6b6b", t.textAlign = "center", t.textBaseline = "middle", t.fillText(this.translationOverlay.errorMessage, v, R), t.restore();
      return;
    }
    ...
    const r = { x: e, y: n, width: i, height: o }, l = this.sampleRegionColor(r), c = l.brightness < 128;
    let g, x;
    if (c) {
    ...
    t.fillStyle = g, t.fillRect(e, n, i, o), t.fillStyle = x, t.textAlign = "left", t.textBaseline = "top";
    ...
    p.length > 0 && this.drawFlowedTranslationBlocks(t, p, e, n, a, i, o);
    for (const v of y)
      this.drawStructuredTranslationBlock(t, v, e, n, a, i, o);
    t.restore();
  }
  drawFlowedTranslationBlocks(t, e, n, i, o, a, r) {
    const l = [...e].filter((M) => (M.translatedText || M.text).trim()).sort((M, D) => {
      const L = M.bbox.y - D.bbox.y;
      return Math.abs(L) > 4 ? L : M.bbox.x - D.bbox.x;
    });
    if (l.length === 0)
      return;
    const c = Math.max(24, r - o * 2), g = o, x = (M, D, L) => l.map((W) => {
      const F = (W.translatedText || W.text).trim(), A = Math.max(12, Math.min(W.fontSize || 16, 48)), O = Math.max(8, Math.round(A * M)), H = W.isCodeBlock ? '"Consolas", "Monaco", monospace' : '"Microsoft YaHei", "PingFang SC", "Hiragino Sans GB", sans-serif', B = Math.max(
        o,
        Math.min(W.bbox.x + o, a * 0.38)
      ), Y = D ? o : B, N = Math.max(48, a - Y - g), it = W.lineHeight || O * 1.35, U = Math.max(
        O * (L ? 1.04 : 1.14),
        Math.min(it * M, O * (L ? 1.18 : 1.42))
      );
      return t.font = `${O}px ${H}`, {
        text: F,
        fontSize: O,
        fontFamily: H,
        lineHeight: U,
        paragraphGap: L ? Math.max(1, U * 0.16) : Math.max(3, U * 0.35),
        x: n + Y,
        lines: this.wrapTextToLines(t, F, N)
      };
    }), d = (M) => M.reduce((D, L, W) => {
      const F = W === M.length - 1 ? 0 : L.paragraphGap;
      return D + L.lines.length * L.lineHeight + F;
    }, 0);
    let y = x(1, !1, !1), p = d(y);
    if (p > c) {
      const M = Math.max(0.56, c / p);
      y = x(M, !1, !1), p = d(y);
    }
    if (p > c && (y = x(1, !0, !1), p = d(y)), p > c) {
      const M = Math.max(0.38, c / p * 0.96);
      y = x(M, !0, !0), p = d(y);
    }
    if (p > c) {
      const M = Math.max(0.3, c / p * 0.94);
      y = x(M, !0, !0), p = d(y);
    }
    const v = Math.min(...l.map((M) => M.bbox.y)), R = i + Math.max(o, Math.min(v, r - o)), E = i + r - o;
    let _ = R + p > E ? i + o : R;
    for (const M of y) {
      t.font = `${M.fontSize}px ${M.fontFamily}`;
      for (const D of M.lines)
        t.fillText(D, M.x, _), _ += M.lineHeight;
      _ += M.paragraphGap;
    }
  }
  drawStructuredTranslationBlock(t, e, n, i, o, a, r) {
    const l = [...e.blocks].sort((x, d) => x.x - d.x), c = Math.max(12, Math.min(e.fontSize || 14, 32)), g = e.lineHeight || c * 1.35;
    t.font = `${c}px "Consolas", "Monaco", monospace`;
    for (const x of l) {
      const d = x.translatedText || x.text;
      if (!d.trim()) continue;
      const y = n + x.x + Math.min(4, o), p = i + x.y, v = l.find((M) => M.x > x.x), R = v ? Math.max(x.width, v.x - x.x - 8) : Math.max(x.width, a - x.x - o), E = this.wrapTextToLines(t, d.trim(), R);
      let _ = p;
      for (const M of E) {
        if (_ + c > i + r) break;
        t.fillText(M, y, _), _ += g;
      }
    }
  }
  /**
  ...
  wrapTextToLines(t, e, n) {
    ...
    if (!i)
      return [];
    const o = [], a = /\s/.test(i) ? i.split(/(\s+)/).filter((c) => c.length > 0) : Array.from(i);
    let r = "";
    const l = (c) => {
      let g = "";
      for (const x of Array.from(c)) {
        const d = g + x;
        t.measureText(d).width > n && g !== "" ? (o.push(g), g = x) : g = d;
      }
      r = g;
    };
    for (const c of a) {
      const g = /^\s+$/.test(c), x = g ? " " : c, d = r + x;
      if (t.measureText(d).width <= n) {
        r = d;
        continue;
      }
      r.trim() && (o.push(r.trimEnd()), r = ""), !g && (t.measureText(x).width > n ? l(x) : r = x);
    }
  ...
  sampleRegionColor(t, e = 16) {
    ...
    if (!this.backgroundImage)
      return n;
    const i = window.devicePixelRatio || 1, o = Math.round(t.width * i), a = Math.round(t.height * i), r = this.canvasPool.acquire(o, a), l = r.getContext("2d");
    if (!l)
      return this.canvasPool.release(r), n;
    const c = this.backgroundImage.width, g = this.backgroundImage.height, x = this.canvas.width / i, d = this.canvas.height / i, y = c / x, p = g / d, v = t.x * y, R = t.y * p, E = t.width * y, _ = t.height * p;
    try {
      l.drawImage(
      ...
      return z.error("[截图] 采样区域绘制失败", C), this.canvasPool.release(r), n;
    }
    let M;
    try {
      M = l.getImageData(0, 0, o, a);
    } catch (C) {
      return z.error("[截图] 获取像素数据失败", C), this.canvasPool.release(r), n;
    }
    const D = M.data, L = Math.ceil(Math.sqrt(e)), W = o / (L + 1), F = a / (L + 1);
    let A = 0, O = 0, H = 0, B = 0;
    for (let C = 1; C <= L; C++)
      for (let k = 1; k <= L && !(B >= e); k++) {
        const $ = Math.floor(k * W), S = Math.floor(C * F);
        if ($ >= 0 && $ < o && S >= 0 && S < a) {
          const V = (S * o + $) * 4;
          V >= 0 && V + 2 < D.length && (A += D[V], O += D[V + 1], H += D[V + 2], B++);
        }
      }
    if (this.canvasPool.release(r), B === 0)
      return n;
    const Y = Math.round(A / B), N = Math.round(O / B), it = Math.round(H / B), U = this.getBrightness(Y, N, it);
    return {
      r: Y,
      g: N,
      b: it,
   ...
   */
  getBrightness(t, e, n) {
    const i = Math.max(0, Math.min(255, t)), o = Math.max(0, Math.min(255, e)), a = Math.max(0, Math.min(255, n));
    return Math.round(0.299 * i + 0.587 * o + 0.114 * a);
  }
  /**
   * 根据采样颜色计算覆盖层样式
  ...
  calculateOverlayStyle(t) {
    ...
    let r, l;
    if (n) {
      const c = Math.max(0, Math.round(t.r * 0.2)), g = Math.max(0, Math.round(t.g * 0.2)), x = Math.max(0, Math.round(t.b * 0.2));
      r = `rgba(${c}, ${g}, ${x}, ${a})`, l = "rgba(255, 255, 255, 0.95)";
    } else {
      const c = Math.min(255, Math.round(t.r + (255 - t.r) * 0.8)), g = Math.min(255, Math.round(t.g + (255 - t.g) * 0.8)), x = Math.min(255, Math.round(t.b + (255 - t.b) * 0.8));
      r = `rgba(${c}, ${g}, ${x}, ${a})`, l = "rgba(0, 0, 0, 0.9)";
    }
    return {
      backgroundColor: r,
      textColor: l,
  ...
  isUniformColor(t, e = 100, n = 16) {
    ...
    try {
      ...
      return z.error("[截图] isUniformColor: 采样区域绘制失败", C), this.canvasPool.release(r), !1;
    }
    let M;
    try {
      M = l.getImageData(0, 0, o, a);
    } catch (C) {
      return z.error("[截图] isUniformColor: 获取像素数据失败", C), this.canvasPool.release(r), !1;
    }
    const D = M.data, L = Math.ceil(Math.sqrt(n)), W = o / (L + 1), F = a / (L + 1), A = [];
    for (let C = 1; C <= L; C++)
      for (let k = 1; k <= L && !(A.length >= n); k++) {
        const $ = Math.floor(k * W), S = Math.floor(C * F);
        if ($ >= 0 && $ < o && S >= 0 && S < a) {
          const V = (S * o + $) * 4;
    ...
    if (this.canvasPool.release(r), A.length < 2)
      return !1;
    const O = A.reduce((C, k) => C + k.r, 0) / A.length, H = A.reduce((C, k) => C + k.g, 0) / A.length, B = A.reduce((C, k) => C + k.b, 0) / A.length, Y = A.reduce((C, k) => C + Math.pow(k.r - O, 2), 0) / A.length, N = A.reduce((C, k) => C + Math.pow(k.g - H, 2), 0) / A.length, it = A.reduce((C, k) => C + Math.pow(k.b - B, 2), 0) / A.length;
    return (Y + N + it) / 3 < e;
  }
  /**
   * 根据OCR块高度估算合适的字体大小
  ...
  estimateFontSize(t) {
    if (t <= 0)
      return 12;
    const e = t * 0.8, n = t * 0.85, o = Math.max(12, Math.min(e, n));
    return Math.round(o);
  }
  /**
   * 根据文字内容和块宽度调整字体大小
  ...
  drawSnapPreview() {
    ...
    if (t) {
      if (t.save(), t.strokeStyle = "#00a8ff", t.lineWidth = 2, t.setLineDash([5, 5]), t.fillStyle = "rgba(0, 168, 255, 0.1)", t.fillRect(
        ...
        const n = Xt(this.snappedWindow).x, i = this.snappedWindow.y - 5, o = t.measureText(this.snappedWindow.title), a = 4;
  ...
  smartCorrectPenAnnotation() {
    ...
    let n = e[0].x, i = e[0].x, o = e[0].y, a = e[0].y;
    e.forEach((y) => {
      n = Math.min(n, y.x), i = Math.max(i, y.x), o = Math.min(o, y.y), a = Math.max(a, y.y);
    });
    const r = i - n, l = a - o;
    let c = 0;
    for (let y = 1; y < e.length; y++)
      c += ot(e[y - 1], e[y]);
    const x = ot(e[0], e[e.length - 1]) / c, d = Math.max(r, l) / Math.max(Math.min(r, l), 1);
    if (x > 0.85 || d > 5) {
  ...
  async processScreenshot(t) {
    ...
    try {
      const { x: e, y: n, width: i, height: o } = this.selectionRect, r = (await j("get_window_info"))?.scale || 1, l = await this.cropFromBackground(e, n, i, o);
      if (!l?.image)
        throw new Error("无法从背景图像裁剪选区");
      const c = await this.renderWithAnnotations(l, r, t);
      t === "copy" ? await j("copy_to_clipboard", { image: c }) : await j("save_screenshot_to_file", { image: c });
    } catch (e) {
  ...
  // 从背景图像裁剪指定区域
  async cropFromBackground(t, e, n, i, o = {}) {
    return new Promise(async (a, r) => {
      ...
      try {
        ...
        const c = window.devicePixelRatio || 1, g = Math.max(0, o.padding || 0), x = this.canvas.width / c, d = this.canvas.height / c, y = t - g, p = e - g, v = n + g * 2, R = i + g * 2, E = Math.max(1, Math.round(v * c)), _ = Math.max(1, Math.round(R * c)), M = Math.max(0, y), D = Math.max(0, p), L = Math.min(x, y + v), W = Math.min(d, p + R), F = Math.max(0, L - M), A = Math.max(0, W - D), O = Math.round(M * c), H = Math.round(D * c), B = Math.min(
          this.canvas.width - O,
          Math.round(F * c)
        ), Y = Math.min(
          this.canvas.height - H,
          Math.round(A * c)
        ), N = Math.round((M - y) * c), it = Math.round((D - p) * c), U = document.createElement("canvas");
        U.width = E, U.height = _;
        ...
        C.imageSmoothingEnabled = !1, o.fillColor && (C.fillStyle = o.fillColor, C.fillRect(0, 0, E, _)), B > 0 && Y > 0 && C.drawImage(
          this.backgroundImage,
          O,
          H,
          B,
      ...
      c.onload = () => {
        try {
          ...
          try {
            ...
            clearTimeout(a), o(new Error(`渲染失败: ${g.message || g}`));
          }
        }
      }, c.onerror = (g) => {
        z.error("[截图] 图像加载失败", g), clearTimeout(a), o(new Error("图像加载失败"));
  ...
  async createPinLikeWindow(t) {
    if (this.selectionRect)
      try {
        const { x: e, y: n, width: i, height: o } = this.selectionRect, a = await j("get_window_info"), r = a?.scale || 1, l = Math.round(a.x + e * r), c = Math.round(a.y + n * r), g = Math.round(i * r), x = Math.round(o * r), d = Math.round(a.x + window.innerWidth * r), y = t === "ocr" ? Math.round(l - Math.max(0, g - g) / 2) : l, p = t === "ocr" ? Math.max(a.x, Math.min(y, d - g)) : l, v = {}, R = await this.cropFromBackground(e, n, i, o, v);
        if (!R?.image)
  ...
  async handleColorPicking(t) {
    if (this.selectionRect)
      try {
        const e = await j("get_window_info"), n = e?.scale || 1, i = Math.round(e.x + (this.selectionRect.x + t.x - this.selectionRect.x) * n), o = Math.round(e.y + (this.selectionRect.y + t.y - this.selectionRect.y) * n), a = await j("get_pixel_color", {
          x: i,
          y: o
  ...
  async updateColorPreview(t) {
    if (this.selectionRect)
      try {
        const e = await j("get_window_info"), n = e?.scale || 1, i = this.colorPickerState.zoomFactor, o = Math.floor(i / 2), a = Math.round(e.x + t.x * n), r = Math.round(e.y + t.y * n), l = await j("get_screen_preview", {
          x: a - o,
          y: r - o,
          width: i,
          height: i
        ...
        const g = await createImageBitmap(c);
        this.colorPickerState.previewImage = g;
        const d = new OffscreenCanvas(i, i).getContext("2d");
        if (d) {
          d.drawImage(g, 0, 0, i, i);
          const y = d.getImageData(o, o, 1, 1).data, p = { r: y[0], g: y[1], b: y[2] }, v = this.rgbToHex(p.r, p.g, p.b);
  ...
  async performOcrTranslation() {
    if (!(!this.selectionRect || !this.backgroundImage))
      try {
        ...
        let e = 0, n = 0, i = 0, o = 0, a = 0;
        const { x: r, y: l, width: c, height: g } = this.selectionRect, x = window.devicePixelRatio || 1, d = c * x, y = g * x, p = this.canvasPool.acquire(d, y), v = p.getContext("2d");
        if (!v)
          throw this.canvasPool.release(p), new Error("无法创建临时canvas");
        const R = r * x, E = l * x, _ = performance.now();
        v.drawImage(
          this.backgroundImage,
          R,
          E,
        ...
        const M = performance.now(), { recognizeFromCanvas: D } = await Rt.loadOCR();
        n = Math.round(performance.now() - M);
        const L = performance.now(), W = await D(p);
        i = Math.round(performance.now() - L), this.canvasPool.release(p);
        const F = {
          cropDurationMs: e,
        ...
        const A = W.blocks, O = performance.now(), H = Be(A);
        o = Math.round(performance.now() - O);
        const B = H.map((h) => h.text).join(`

`), Y = {
          rawLineCount: A.length,
          paragraphCount: H.length,
          durationMs: o,
          paragraphs: H.map((h, T) => ({
            index: T,
            text: h.text,
            blockCount: h.blocks.length,
            isCodeBlock: !!h.isCodeBlock,
            isStructuredBlock: !!h.isStructuredBlock,
            bbox: h.bbox,
            sourceBlocks: h.blocks.map((J) => ({
              text: J.text,
              x: J.x,
              y: J.y,
              width: J.width,
        ...
        this.translationOverlay.sourceLanguage = "auto", this.translationOverlay.targetLanguage = this.getAutoTargetLanguage(Lt(B));
        const it = (h) => {
          const T = h.trim();
        ...
        z.info("[OCR] 翻译语言检测完成", k), pt.log("[OCR] translation language detected", k), _t(C) && (this.translationOverlay.sourceLanguage = C, this.translationOverlay.targetLanguage = this.getAutoTargetLanguage(C));
        const $ = N === "offline" ? Rt.loadOfflineTranslator() : null, S = (h) => N === "offline" ? h.includes("未激活") || h.includes("未下载") || h.includes("运行时未安装") ? h : h.includes("超时") ? "模型加载超时，请重试" : h.includes("离线翻译暂仅支持") ? h : "离线翻译失败: " + h.substring(0, 50) : "翻译失败，请检查网络连接", V = async () => {
          if (!$)
          ...
          if (!G || it(G))
            return h;
          const st = h.match(/^(\s*)(\S+)(\s{2,})(.+?)(\s*)$/);
          if (st) {
            const [, gt, Q, K, tt, yt] = st, bt = Lt(Q), Vt = et(Q) || !_t(bt) ? Q : await lt(Q, bt, this.getAutoTargetLanguage(bt)), Pt = Lt(tt), Zt = _t(Pt) && !it(tt) ? await lt(tt, Pt, this.getAutoTargetLanguage(Pt)) : tt;
          ...
          const J = performance.now(), G = (nt) => ({
            ...
            ...nt
          }), st = Lt(h.text), q = this.getAutoTargetLanguage(st), mt = {
            index: T,
            text: h.text,
            sourceLanguage: st,
            targetLanguage: q,
            engine: N,
            structured: !!h.isStructuredBlock
          };
          if (z.info("[OCR] 段落翻译方向", mt), pt.log("[OCR] paragraph translation direction", mt), !_t(st)) {
            h.translatedText = h.text;
            const nt = G({
              skipped: !0,
              cancelled: !1,
          ...
          try {
            if (h.isStructuredBlock && h.blocks.length > 0) {
              const gt = async (K, tt) => {
                const yt = await Ct(K.text, T, tt);
                return K.translatedText = yt, yt;
              }, Q = [];
              if (N === "offline")
                for (let K = 0; K < h.blocks.length; K += 1)
                  Q.push(await gt(h.blocks[K], K));
              else
                Q.push(
                  ...await Promise.all(
                    h.blocks.map((K, tt) => gt(K, tt))
                  )
                );
              h.translatedText = Q.join(" ");
            } else if (it(h.text) || h.isCodeBlock) {
              h.translatedText = h.text;
              const gt = h.isCodeBlock ? "code_block" : "command_like_text", Q = G({ skipped: !0, cancelled: !1 }), K = {
                index: T,
                reason: gt,
            ...
            const nt = G({ skipped: !1, cancelled: !1 }), ct = {
              ...
              engine: N,
              structured: !!h.isStructuredBlock,
              sourceLength: h.text.length,
              translatedLength: (h.translatedText || "").length,
              translatedPreview: (h.translatedText || "").slice(0, 300)
            };
        ...
        if (N === "offline")
          ...
          if (at = await Promise.all(
            H.map((h, T) => wt(h, T))
          ), at.some((h) => h.cancelled))
            return;
          U = at.find((h) => h.errorMessage)?.errorMessage || "";
        }
        ...
        const ut = {
          ...
          engine: N,
          paragraphCount: H.length,
          translatedParagraphCount: at.filter((h) => !h.skipped && !h.errorMessage).length,
          skippedParagraphCount: at.filter((h) => h.skipped).length,
          failedParagraphCount: at.filter((h) => !!h.errorMessage).length
        };
        z.info("[OCR] 翻译耗时统计", ut), pt.log("[OCR] translation timing", ut);
        const vt = H.map((h) => this.toDisplayParagraph(h, x)), Nt = vt.map((h) => this.toLegacyOverlayBlock(h));
...
const dn = Mt("arrow-left-up", !0, function(s) {
  return b("svg", {
    width: s.size,
    height: s.size,
    viewBox: "0 0 48 48",
...
}), un = Mt("delete-four", !1, function(s) {
  return b("svg", {
    width: s.size,
    height: s.size,
    viewBox: "0 0 48 48",
...
}), mn = Mt("rectangle-one", !1, function(s) {
  return b("svg", {
    width: s.size,
    height: s.size,
    viewBox: "0 0 48 48",
...
}), vn = { class: "toolbar-container" }, kn = { class: "toolbar-panel first-panel" }, Sn = { class: "tool-section" }, Mn = ["onClick", "title"], bn = { class: "action-section" }, Cn = ["disabled", "title"], Tn = ["disabled", "title"], Rn = ["title"], An = ["title"], Pn = ["title"], zn = {
  key: 0,
  class: "toolbar-panel second-panel"
}, Dn = { class: "style-section" }, Ln = {
  key: 0,
  class: "style-group"
}, Wn = { class: "line-width-selector" }, In = ["onClick", "title"], _n = {
  key: 1,
  ...
  setup(s, { emit: t }) {
    const e = ft(!1), { t: n } = ke(), i = s, o = t, a = rt(() => [
      { type: u.Select, icon: wn, title: n("screenshot.select") },
      { type: u.Rectangle, icon: mn, title: n("screenshot.rectangle") },
      { type: u.Arrow, icon: dn, title: n("screenshot.arrow") },
      { type: u.Pen, icon: pn, title: n("screenshot.pen") },
      { type: u.Mosaic, icon: xn, title: n("screenshot.mosaic") },
      { type: u.Text, icon: fn, title: n("screenshot.text") },
      { type: u.ColorPicker, icon: ee, title: n("screenshot.colorPicker") },
      { type: u.Ocr, icon: Se, title: n("screenshot.ocr") },
      { type: u.Translate, icon: Me, title: n("screenshot.translate") },
    ...
    ]), l = [2, 3, 5, 8], c = ["#ff4444", "#44ff44", "#4444ff"], g = [12, 14, 16, 18, 20, 24], x = [5, 8, 10, 15], d = rt(() => ![u.Select, u.ColorPicker, u.Ocr, u.Pin].includes(i.currentTool)), y = rt(
      () => [u.Rectangle, u.Arrow, u.Pen].includes(i.currentTool)
    ), p = rt(
      () => [u.Rectangle, u.Arrow, u.Pen, u.Text].includes(i.currentTool)
    ), v = rt(() => i.currentTool === u.Text), R = rt(() => i.currentTool === u.Mosaic), E = rt(() => i.currentTool === u.Translate), _ = (k) => o("tool-select", k), M = (k) => o("color-change", k), D = (k) => o("line-width-change", k), L = (k) => o("text-size-change", k), W = (k) => o("mosaic-size-change", k), F = () => o("undo"), A = () => o("delete"), O = () => o("save"), H = () => o("confirm"), B = () => o("cancel"), Y = (k) => {
      o("translate-engine-change", k);
    }, N = () => {
      e.value = !e.value;
    }, it = (k) => {
      M(k), e.value = !1;
            ...
            e.value ? (X(), Z("div", Bn, [
              P("div", En, [
                ...
                P("div", $n, [
                  P("button", {
                    onClick: U,
                    class: Tt(["color-btn custom-color-btn", { active: !c.includes(k.currentColor) }]),
...
}), Qn = /* @__PURE__ */ oe(Jn, [["__scopeId", "data-v-85a650ef"]]), ti = {
  ...
  setup(s) {
    ...
    let i = null;
    const o = ft(!0), a = ft(!1), r = ft(""), l = ft({ x: 0, y: 0 }), c = ft(!1), g = ft("bing");
    let x = !1;
    const d = ft({
      selectionRect: null,
      annotations: [],
      ...
      if (!d.value.selectionRect) return {};
      const { y: f, height: h } = d.value.selectionRect;
      return {
        top: `${f + h}px`,
        left: "0",
        right: "0",
      ...
      if (!d.value.selectionRect) return {};
      const { x: f, y: h, height: T } = d.value.selectionRect;
      return {
        top: `${h}px`,
        left: "0",
        width: `${f}px`,
      ...
      if (!d.value.selectionRect) return {};
      const { x: f, y: h, width: T, height: J } = d.value.selectionRect;
      return {
        top: `${h}px`,
        left: `${f + T}px`,
        right: "0",
      ...
      if (!d.value.selectionRect) return {};
      const { x: f, y: h, height: T } = d.value.selectionRect, J = 48, G = 48, st = 8, q = 10, mt = ![u.Select, u.ColorPicker, u.Ocr, u.Pin].includes(d.value.currentTool), nt = mt ? J + G + st : J, ct = 510;
      let gt = 0;
      mt && (d.value.currentTool === u.Text ? gt = 380 : d.value.currentTool === u.Mosaic ? gt = 250 : gt = 320);
      const Q = Math.max(ct, gt);
      let K;
      h + T + nt + q < window.innerHeight ? K = h + T + q : h - nt - q > 0 ? K = h - nt - q : K = Math.max(h + T - nt - q, h + 10);
      let tt;
      ...
      if (!d.value.selectionRect) return {};
      const { x: f, y: h, width: T, height: J } = d.value.selectionRect, G = 10;
      let st = f - G, q = h - G, mt = "translateY(-100%)";
      return st < 10 && (st = f + T + G, mt = "translateY(-100%)"), q < 30 && (q = h + J + G, mt = "translateY(0)"), {
        left: `${st}px`,
        top: `${q}px`,
        transform: mt
      };
      ...
      if (!d.value.selectionRect) return "";
      const { width: f, height: h } = d.value.selectionRect;
      return `${Math.round(f)} × ${Math.round(h)}`;
    }), F = rt(() => {
      ...
      try {
        ...
        const h = f?.message || f?.toString() || "保存失败";
    ...
    const Ct = (f, h) => {
      if (h && h.getData().type === "text") {
        ...
        l.value = f;
      a.value = !0, et = h || null, h && i?.setEditingAnnotation(h), h && h.getData().text ? r.value = h.getData().text : r.value = "", ve(() => {
      ...
      navigator.clipboard && navigator.clipboard.writeText(f.hex).catch((h) => {
        z.error("[截图] 复制颜色到剪贴板失败", h);
      });
    }, ut = (f) => {
      ...
      if ((h ? f.metaKey : f.ctrlKey) && f.key.toLowerCase() === "z") {
        f.shiftKey ? k() : C(), f.preventDefault();
        return;
      }
      if (!h && f.ctrlKey && f.key.toLowerCase() === "y") {
        k(), f.preventDefault();
        return;
      }
      if (f.key === "Escape") {
      ...
      if (!x) {
        ...
        d.value = {
          ...
          selectedAnnotation: null,
          isDrawing: !1
        }, a.value = !1, r.value = "", et = null, c.value = !1, o.value = !0;
        try {
    ...
    return we(async () => {
      if (t.value) {
        n.value = new se("screenshot"), await n.value.emit("screenshot_ready"), i = new hn(
          t.value,
          Nt,
          Ct,
          at
      ...
      [
        ...
        I(" 尺寸信息 "),
        d.value.selectionRect && o.value ? (X(), Z(
          "div",
          {
            key: 2,
            class: "size-info",
        ...
        c.value ? (X(), Z("div", si, [
          ...
          P(
            "p",
            null,
            Ht(f.$t("screenshotTool.loading")),
            1
            /* TEXT */
          )
        ])) : I("v-if", !0),
        I(" 提示信息 "),
        !d.value.selectionRect && !c.value ? (X(), Z("div", oi, [
          P(
            "p",
            null,
            Ht(f.$t("screenshotTool.dragToSelect")),
            1
            /* TEXT */
          ),
          P(
            "p",
            ai,
            Ht(f.$t("screenshotTool.pressEscToClose")),
            1
            /* TEXT */
          )
        ])) : I("v-if", !0),
...
}), di = /* @__PURE__ */ oe(ri, [["__scopeId", "data-v-cba0f9c3"]]);
export {
  di as default
};
